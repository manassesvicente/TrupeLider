...
//----- Limpa variável de segurança
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_LiderResultado"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_LiderResultado"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_LiderResultado']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['app_LiderResultado']['opc_psq']) || $fecha_janela)
   {
...
<HTML>
<HEAD>
 <TITLE>app_LiderResultado</TITLE>
