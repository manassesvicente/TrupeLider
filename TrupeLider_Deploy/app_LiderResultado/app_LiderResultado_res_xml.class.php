...
class app_LiderResultado_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- Construtor
   function app_LiderResultado_xml()
   {
   ...
   {
      require_once($this->Ini->path_aplicacao . "app_LiderResultado_resumo.class.php"); 
      $this->nm_data    = new nm_data("pt_br");
      $this->arquivo    = "sc_xml";
      ...
      $this->arquivo   .= ".xml";
      $this->Res       = new app_LiderResultado_resumo("out");
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderResultado']['arr_total']['lider'] as $campo_lider => $dados_lider)
      {
   ...
   {
      $xml_registro  = "<app_LiderResultado";
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas do Líder - Resultado Geral :: XML</TITLE>
