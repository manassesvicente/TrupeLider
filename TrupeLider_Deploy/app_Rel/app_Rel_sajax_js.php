...
//      document.F1.elements[sFieldName].value = scAjaxSpecCharParser(sFieldValue);
  ...
  // ---------- save_filter
  function app_Rel_do_ajax_save_filter()
  {
    var var_id_votado_cond = scAjaxGetFieldSelect("id_votado_cond");
    var var_id_votado = scAjaxGetFieldText("id_votado");
    var var_id_etapa_cond = scAjaxGetFieldSelect("id_etapa_cond");
    var var_id_etapa = scAjaxGetFieldText("id_etapa");
    var var_id_competencia_cond = scAjaxGetFieldSelect("id_competencia_cond");
    var var_id_competencia = scAjaxGetFieldText("id_competencia");
    var var_id_habilidade_cond = scAjaxGetFieldSelect("id_habilidade_cond");
    ...
    x_app_Rel_ajax_save_filter( var_id_votado_cond, var_id_votado, var_id_etapa_cond, var_id_etapa, var_id_competencia_cond, var_id_competencia, var_id_habilidade_cond, var_id_habilidade, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, app_Rel_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function app_Rel_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function app_Rel_do_ajax_change_filter()
  {
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters");
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_app_Rel_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, app_Rel_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function app_Rel_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
  ...
  // ---------- delete_filter
  function app_Rel_do_ajax_delete_filter()
  {
    var var_NM_filters_del = scAjaxGetFieldSelect("NM_filters_del");
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_app_Rel_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, app_Rel_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function app_Rel_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    document.F1.NM_filters.selectedIndex = -1;
  ...
  ajax_field_list[0] = "id_votado";
  ajax_field_list[1] = "id_etapa";
  ajax_field_list[2] = "id_competencia";
  ajax_field_list[3] = "id_habilidade";

  var ajax_error_list = {
    "id_votado": {"label": "Votado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "id_etapa": {"label": "Etapa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "id_competencia": {"label": "Competência", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "id_habilidade": {"label": "Habilidade", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
