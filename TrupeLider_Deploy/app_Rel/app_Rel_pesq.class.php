...
class app_Rel_pesq
{
   ...
   {
      global 
      $id_votado_cond, $id_votado,
             $id_etapa_cond, $id_etapa,
             $id_competencia_cond, $id_competencia,
             $id_habilidade_cond, $id_habilidade,
      $NM_filters, $NM_filters_del, $nmgp_save_name, $NM_operador, $nmgp_save_option, $bprocessa, $Ajax_label, $Ajax_val, $Campo_bi, $Opc_bi;
      $this->init();
      if (isset($this->NM_ajax_info['param']['id_votado_cond']))
      {
          $id_votado_cond = $this->NM_ajax_info['param']['id_votado_cond'];
      }
      if (isset($this->NM_ajax_info['param']['id_votado']))
      {
          $id_votado = $this->NM_ajax_info['param']['id_votado'];
      }
      if (isset($this->NM_ajax_info['param']['id_etapa_cond']))
      {
          $id_etapa_cond = $this->NM_ajax_info['param']['id_etapa_cond'];
      }
      if (isset($this->NM_ajax_info['param']['id_etapa']))
      {
          $id_etapa = $this->NM_ajax_info['param']['id_etapa'];
      }
      if (isset($this->NM_ajax_info['param']['id_competencia_cond']))
      {
          $id_competencia_cond = $this->NM_ajax_info['param']['id_competencia_cond'];
      }
      if (isset($this->NM_ajax_info['param']['id_competencia']))
      {
          $id_competencia = $this->NM_ajax_info['param']['id_competencia'];
      }
      if (isset($this->NM_ajax_info['param']['id_habilidade_cond']))
      {
          $id_habilidade_cond = $this->NM_ajax_info['param']['id_habilidade_cond'];
      }
      if (isset($this->NM_ajax_info['param']['id_habilidade']))
      {
          $id_habilidade = $this->NM_ajax_info['param']['id_habilidade'];
      }
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_aspas = "'";
      $nm_numeric[] = "id_votado";$nm_numeric[] = "id_grupo";$nm_numeric[] = "id_votante";$nm_numeric[] = "id_etapa";$nm_numeric[] = "id_competencia";$nm_numeric[] = "id_habilidade";$nm_numeric[] = "resultado";
      ...
      else
      {
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // Exatamente igual
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // In&iacute;cio igual
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " iniciando por " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // Qualquer parte
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " que contenha " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= " " . $nome_sum . " like '%" . $campo . "%'";
                   $this->comando_filtro .= " " . $nome . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " que contenha " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // Diferente
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " diferente de " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // Maior que
               $this->comando        .= " $nome > " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum > " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome > " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " maior que " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // Maior ou igual
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " maior ou igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // Menor que
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " menor que " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // Menor ou igual
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " menor ou igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // Entre dois valores
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " entre " . $this->cmp_formatado[$nome_campo] . " e " . $this->cmp_formatado[$nome_campo . "2"] . "##*@@";
                   }
               }
            break;
            ...
            case "NU":     // Conte&uacute;do nulo
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " Conte&uacute;do nulo " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // Conte&uacute;do n&atilde;o nulo
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " Conte&uacute;do n&atilde;o nulo " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "app_Rel.php";
?>
<HTML>
<HEAD>
 <TITLE>Filtro para app_Rel</TITLE>
...
<HEAD>
 <TITLE>Filtro para app_Rel</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
<SCRIPT language="javascript" src="app_Rel_digita.js" ?>">
</SCRIPT>
<SCRIPT language="javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>">
</SCRIPT>
<SCRIPT language="javascript" src="app_Rel_tab_erro.js">
</SCRIPT>
 <SCRIPT language="javascript">
var NM_index = 0;
...
function NM_hide_menu()
{
 ...
 function nm_submit_filter_del()
 {
  ...
  app_Rel_do_ajax_delete_filter();
 }
 </SCRIPT>
<?php
include_once("app_Rel_sajax_js.php");
?>
</HEAD>
<BODY>
 <FORM name="F1" action="app_Rel.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page; ?>"> 
...
<?php
   ...
   {
?>
   <FORM name="form_cancel"  method="POST" action="app_Rel.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page; ?>"> 
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          $id_votado = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_votado']; 
          $id_votado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_votado_cond']; 
          $id_etapa = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_etapa']; 
          $id_etapa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_etapa_cond']; 
          $id_competencia = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_competencia']; 
          $id_competencia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_competencia_cond']; 
          $id_habilidade = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_habilidade']; 
          $id_habilidade_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_habilidade_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($id_votado_cond) || empty($id_votado_cond))
      {
         $id_votado_cond = "eq";
      }
      if (!isset($id_etapa_cond) || empty($id_etapa_cond))
      {
         $id_etapa_cond = "eq";
      }
      if (!isset($id_competencia_cond) || empty($id_competencia_cond))
      {
         $id_competencia_cond = "eq";
      }
      if (!isset($id_habilidade_cond) || empty($id_habilidade_cond))
      {
         $id_habilidade_cond = "eq";
      }
      if (!isset($id_votado) || empty($id_votado))
      {
          $id_votado = "";
      }
      if (isset($id_votado) && !empty($id_votado))
      ...
      if (!isset($id_etapa) || empty($id_etapa))
      {
          $id_etapa = "";
      }
      if (isset($id_etapa) && !empty($id_etapa))
      ...
      if (!isset($id_competencia) || empty($id_competencia))
      {
          $id_competencia = "";
      }
      if (isset($id_competencia) && !empty($id_competencia))
      ...
      if (!isset($id_habilidade) || empty($id_habilidade))
      {
          $id_habilidade = "";
      }
      if (isset($id_habilidade) && !empty($id_habilidade))
...
?>
  ...
  <TD width="100%" height="">
   ...
   <tr>
     ...
     <TD class="css_lab_impar">
        <?php echo (isset($this->New_label['id_votado'])) ? $this->New_label['id_votado'] : "Votado"; ?>
     </TD>
     <TD class="css_cmp_impar"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="id_votado_cond">
       <OPTION value="eq" <?php if ("eq" == $id_votado_cond) { echo "selected"; } ?>>Exatamente igual</OPTION>
       <OPTION value="ii" <?php if ("ii" == $id_votado_cond) { echo "selected"; } ?>>In&iacute;cio igual</OPTION>
       <OPTION value="qp" <?php if ("qp" == $id_votado_cond) { echo "selected"; } ?>>Qualquer parte</OPTION>
       <OPTION value="df" <?php if ("df" == $id_votado_cond) { echo "selected"; } ?>>Diferente</OPTION>
      </SELECT>
       </TD>
     <TD  class="css_cmp_impar">
 ...
 $nmgp_tab_label .= "id_votado?#?" . $SC_Label . "?@?";
?>
<INPUT  type="text" name="id_votado" value="<?php echo $id_votado ?>"   onblur="if (this.value != ''){ NM_onblur(); } else { NM_onblur(); this.value=''; }" onfocus="NM_onfocus(this.form.name, this.name, '<?php echo $SC_Label ?>', 0, 'naomask', 'numeroedt' , 10, -0, 9999999999)" size=4 style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
     ...
     <TD class="css_lab_par">
        <?php echo (isset($this->New_label['id_etapa'])) ? $this->New_label['id_etapa'] : "Etapa"; ?>
     </TD>
     <TD class="css_cmp_par"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="id_etapa_cond">
       <OPTION value="eq" <?php if ("eq" == $id_etapa_cond) { echo "selected"; } ?>>Exatamente igual</OPTION>
       <OPTION value="ii" <?php if ("ii" == $id_etapa_cond) { echo "selected"; } ?>>In&iacute;cio igual</OPTION>
       <OPTION value="qp" <?php if ("qp" == $id_etapa_cond) { echo "selected"; } ?>>Qualquer parte</OPTION>
       <OPTION value="df" <?php if ("df" == $id_etapa_cond) { echo "selected"; } ?>>Diferente</OPTION>
      </SELECT>
       </TD>
     <TD  class="css_cmp_par">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "id_etapa?#?" . $SC_Label . "?@?";
?>
<INPUT  type="text" name="id_etapa" value="<?php echo $id_etapa ?>"   onblur="if (this.value != ''){ NM_onblur(); } else { NM_onblur(); this.value=''; }" onfocus="NM_onfocus(this.form.name, this.name, '<?php echo $SC_Label ?>', 0, 'naomask', 'numeroedt' , 10, -0, 9999999999)" size=4 style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
     ...
     <TD class="css_lab_impar">
        <?php echo (isset($this->New_label['id_competencia'])) ? $this->New_label['id_competencia'] : "Competência"; ?>
     </TD>
     <TD class="css_cmp_impar"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="id_competencia_cond">
       <OPTION value="eq" <?php if ("eq" == $id_competencia_cond) { echo "selected"; } ?>>Exatamente igual</OPTION>
       <OPTION value="ii" <?php if ("ii" == $id_competencia_cond) { echo "selected"; } ?>>In&iacute;cio igual</OPTION>
       <OPTION value="qp" <?php if ("qp" == $id_competencia_cond) { echo "selected"; } ?>>Qualquer parte</OPTION>
       <OPTION value="df" <?php if ("df" == $id_competencia_cond) { echo "selected"; } ?>>Diferente</OPTION>
      </SELECT>
       </TD>
     <TD  class="css_cmp_impar">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "id_competencia?#?" . $SC_Label . "?@?";
?>
<INPUT  type="text" name="id_competencia" value="<?php echo $id_competencia ?>"   onblur="if (this.value != ''){ NM_onblur(); } else { NM_onblur(); this.value=''; }" onfocus="NM_onfocus(this.form.name, this.name, '<?php echo $SC_Label ?>', 0, 'naomask', 'numeroedt' , 10, -0, 9999999999)" size=4 style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
     ...
     <TD class="css_lab_par">
        <?php echo (isset($this->New_label['id_habilidade'])) ? $this->New_label['id_habilidade'] : "Habilidade"; ?>
     </TD>
     <TD class="css_cmp_par"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="id_habilidade_cond">
       <OPTION value="eq" <?php if ("eq" == $id_habilidade_cond) { echo "selected"; } ?>>Exatamente igual</OPTION>
       <OPTION value="ii" <?php if ("ii" == $id_habilidade_cond) { echo "selected"; } ?>>In&iacute;cio igual</OPTION>
       <OPTION value="qp" <?php if ("qp" == $id_habilidade_cond) { echo "selected"; } ?>>Qualquer parte</OPTION>
       <OPTION value="df" <?php if ("df" == $id_habilidade_cond) { echo "selected"; } ?>>Diferente</OPTION>
      </SELECT>
       </TD>
     <TD  class="css_cmp_par">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "id_habilidade?#?" . $SC_Label . "?@?";
?>
<INPUT  type="text" name="id_habilidade" value="<?php echo $id_habilidade ?>"   onblur="if (this.value != ''){ NM_onblur(); } else { NM_onblur(); this.value=''; }" onfocus="NM_onfocus(this.form.name, this.name, '<?php echo $SC_Label ?>', 0, 'naomask', 'numeroedt' , 10, -0, 9999999999)" size=4 style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_Rel']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app_Rel']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_votado.value = "";
   document.F1.id_etapa.value = "";
   document.F1.id_competencia.value = "";
   document.F1.id_habilidade.value = "";
 }
 </script>
<?php
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      { 
          $NM_str_filter  = "";
          $NM_temp  = (isset($id_votado)) ? $id_votado : ""; 
          $NM_str_filter .= "id_votado#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_votado_cond)) ? $id_votado_cond : ""; 
          $NM_str_filter .= "id_votado_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_etapa)) ? $id_etapa : ""; 
          $NM_str_filter .= "id_etapa#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_etapa_cond)) ? $id_etapa_cond : ""; 
          $NM_str_filter .= "id_etapa_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_competencia)) ? $id_competencia : ""; 
          $NM_str_filter .= "id_competencia#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_competencia_cond)) ? $id_competencia_cond : ""; 
          $NM_str_filter .= "id_competencia_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_habilidade)) ? $id_habilidade : ""; 
          $NM_str_filter .= "id_habilidade#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_habilidade_cond)) ? $id_habilidade_cond : ""; 
          $NM_str_filter .= "id_habilidade_cond#NMF#" . $NM_temp . "@NMF@"; 
   ...
   function recupera_filtro()
   {
      ...
      $Look_man = array();
      $tp_html['id_votado_cond'] = 'select';
      $tp_html['id_etapa_cond'] = 'select';
      $tp_html['id_competencia_cond'] = 'select';
      $tp_html['id_habilidade_cond'] = 'select';
      $tp_html['id_votado'] = 'text';
      $tp_html['id_etapa'] = 'text';
      $tp_html['id_competencia'] = 'text';
      $tp_html['id_habilidade'] = 'text';
   ...
   {
      global $id_votado_cond, $id_votado,
             $id_etapa_cond, $id_etapa,
             $id_competencia_cond, $id_competencia,
             $id_habilidade_cond, $id_habilidade, $nmgp_tab_label;
      ...
      $id_votado_cond_salva = $id_votado_cond; 
      if (!isset($id_votado_input_2) || $id_votado_input_2 == "")
      {
          $id_votado_input_2 = $id_votado;
      }
      $id_etapa_cond_salva = $id_etapa_cond; 
      if (!isset($id_etapa_input_2) || $id_etapa_input_2 == "")
      {
          $id_etapa_input_2 = $id_etapa;
      }
      $id_competencia_cond_salva = $id_competencia_cond; 
      if (!isset($id_competencia_input_2) || $id_competencia_input_2 == "")
      {
          $id_competencia_input_2 = $id_competencia;
      }
      $id_habilidade_cond_salva = $id_habilidade_cond; 
      if (!isset($id_habilidade_input_2) || $id_habilidade_input_2 == "")
      {
          $id_habilidade_input_2 = $id_habilidade;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_votado'] = $id_votado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_votado_cond'] = $id_votado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_etapa'] = $id_etapa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_etapa_cond'] = $id_etapa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_competencia'] = $id_competencia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_competencia_cond'] = $id_competencia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_habilidade'] = $id_habilidade; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['id_habilidade_cond'] = $id_habilidade_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $id_votado;
      if ($id_votado_cond != "II" && $id_votado_cond != "QP" && $id_votado_cond != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "2", "") ; 
      } 
      $this->cmp_formatado['id_votado'] = $Conteudo;
      $Conteudo = $id_votado_input_2;
      if ($id_votado_cond != "II" && $id_votado_cond != "QP" && $id_votado_cond != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "2", "") ; 
      } 
      $this->cmp_formatado['id_votado2'] = $Conteudo;
      nm_limpa_numero($id_votado) ; 
      $Conteudo = $id_etapa;
      if ($id_etapa_cond != "II" && $id_etapa_cond != "QP" && $id_etapa_cond != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "2", "") ; 
      } 
      $this->cmp_formatado['id_etapa'] = $Conteudo;
      $Conteudo = $id_etapa_input_2;
      if ($id_etapa_cond != "II" && $id_etapa_cond != "QP" && $id_etapa_cond != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "2", "") ; 
      } 
      $this->cmp_formatado['id_etapa2'] = $Conteudo;
      nm_limpa_numero($id_etapa) ; 
      $Conteudo = $id_competencia;
      if ($id_competencia_cond != "II" && $id_competencia_cond != "QP" && $id_competencia_cond != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "2", "") ; 
      } 
      $this->cmp_formatado['id_competencia'] = $Conteudo;
      $Conteudo = $id_competencia_input_2;
      if ($id_competencia_cond != "II" && $id_competencia_cond != "QP" && $id_competencia_cond != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "2", "") ; 
      } 
      $this->cmp_formatado['id_competencia2'] = $Conteudo;
      nm_limpa_numero($id_competencia) ; 
      $Conteudo = $id_habilidade;
      if ($id_habilidade_cond != "II" && $id_habilidade_cond != "QP" && $id_habilidade_cond != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "2", "") ; 
      } 
      $this->cmp_formatado['id_habilidade'] = $Conteudo;
      $Conteudo = $id_habilidade_input_2;
      if ($id_habilidade_cond != "II" && $id_habilidade_cond != "QP" && $id_habilidade_cond != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "0", "S", "2", "") ; 
      } 
      $this->cmp_formatado['id_habilidade2'] = $Conteudo;
      nm_limpa_numero($id_habilidade) ; 

      //----- $id_votado
      if (isset($id_votado) || $id_votado_cond == "nu" || $id_votado_cond == "nn")
      {
         $this->monta_condicao("ID_VOTADO", $id_votado_cond, $id_votado, "", "id_votado");
      }

      //----- $id_etapa
      if (isset($id_etapa) || $id_etapa_cond == "nu" || $id_etapa_cond == "nn")
      {
         $this->monta_condicao("ID_ETAPA", $id_etapa_cond, $id_etapa, "", "id_etapa");
      }

      //----- $id_competencia
      if (isset($id_competencia) || $id_competencia_cond == "nu" || $id_competencia_cond == "nn")
      {
         $this->monta_condicao("ID_COMPETENCIA", $id_competencia_cond, $id_competencia, "", "id_competencia");
      }

      //----- $id_habilidade
      if (isset($id_habilidade) || $id_habilidade_cond == "nu" || $id_habilidade_cond == "nn")
      {
         $this->monta_condicao("ID_HABILIDADE", $id_habilidade_cond, $id_habilidade, "", "id_habilidade");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['where_pesq_lookup'] = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['where_pesq'] = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['where_pesq_salvo'] = $this->comando . $this->comando_fim;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['opcao'] = "pesq";
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['prim_vez'] = "N";
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_Rel']['cond_pesq'] .= $this->NM_operador;
      }
