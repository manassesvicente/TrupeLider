...
class app_Rel_csv
{
   ...
   {
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->look_id_votado);
   ...
   {
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->look_id_votante);
      $this->csv_registro .= $this->delim_col . $this->delim_dados . $conteudo . $this->delim_dados;
   }
   //----- id_etapa
   function NM_export_id_etapa()
   {
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->look_id_etapa);
      $this->csv_registro .= $this->delim_col . $this->delim_dados . $conteudo . $this->delim_dados;
   }
   //----- id_competencia
   function NM_export_id_competencia()
   {
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->look_id_competencia);
      $this->csv_registro .= $this->delim_col . $this->delim_dados . $conteudo . $this->delim_dados;
   }
   //----- id_habilidade
   function NM_export_id_habilidade()
   {
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->look_id_habilidade);
      $this->csv_registro .= $this->delim_col . $this->delim_dados . $conteudo . $this->delim_dados;
   }
   //----- resultado
...
<HTML>
<HEAD>
 <TITLE>Consulta em app_Rel :: CSV</TITLE>
