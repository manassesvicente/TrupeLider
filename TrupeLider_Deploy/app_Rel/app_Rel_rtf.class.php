...
class app_Rel_rtf
{
   ...
   {
         $this->texto_tag .= "<td>" . $this->look_id_votado . "</td>\r\n";
   }
   //----- id_grupo
   ...
   {
         $this->texto_tag .= "<td>" . $this->look_id_votante . "</td>\r\n";
   }
   //----- id_etapa
   function NM_export_id_etapa()
   {
         $this->texto_tag .= "<td>" . $this->look_id_etapa . "</td>\r\n";
   }
   //----- id_competencia
   function NM_export_id_competencia()
   {
         $this->texto_tag .= "<td>" . $this->look_id_competencia . "</td>\r\n";
   }
   //----- id_habilidade
   function NM_export_id_habilidade()
   {
         $this->texto_tag .= "<td>" . $this->look_id_habilidade . "</td>\r\n";
   }
   //----- resultado
...
<HTML>
<HEAD>
 <TITLE>Consulta em app_Rel :: RTF</TITLE>
