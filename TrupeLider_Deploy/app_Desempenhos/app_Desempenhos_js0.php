...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_Desempenhos']['parms'] ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page ?>"/> 
</form> 
...
{ 
    ...
    { 
       if (confirm ("Deseja efetivar as alterações e Excluir os registros marcados?"))  
       { 
...
{ 
    ...
    do_ajax_app_Desempenhos_submit_form(y, z); 
} 
<?php
}
?>
