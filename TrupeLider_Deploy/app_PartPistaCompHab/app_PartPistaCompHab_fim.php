...
//----- Limpa variável de segurança
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_PartPistaCompHab"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_PartPistaCompHab"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_PartPistaCompHab']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['app_PartPistaCompHab']['opc_psq']) || $fecha_janela)
   {
...
<HTML>
<HEAD>
 <TITLE>app_PartPistaCompHab</TITLE>
