...
class app_PartPistaCompHab_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   {
      require_once($this->Ini->path_aplicacao . "app_PartPistaCompHab_resumo.class.php"); 
      $this->nm_data    = new nm_data("pt_br");
      $this->arquivo    = "sc_xml";
      ...
      $this->arquivo   .= ".xml";
      $this->Res       = new app_PartPistaCompHab_resumo("out");
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['arr_total']['participante'] as $campo_participante => $dados_participante)
      {
         $this->resumo_campos = $dados_participante;
         $this->grava_linha($xml_f, $campo_participante, 0);
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['arr_total']['pista'][$campo_participante] as $campo_pista => $dados_pista)
         {
            $this->resumo_campos = $dados_pista;
            $this->grava_linha($xml_f, $campo_pista, 1);
            foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['arr_total']['competencia'][$campo_participante][$campo_pista] as $campo_competencia => $dados_competencia)
            {
               $this->resumo_campos = $dados_competencia;
               $this->grava_linha($xml_f, $campo_competencia, 2);
            }
         }
      }
      fwrite($xml_f, "</root>");
   ...
   {
      $xml_registro  = "<app_PartPistaCompHab";
