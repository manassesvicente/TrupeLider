...
class app_PartPistaCompHab_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $arquivo;
   //---- Construtor
   function app_PartPistaCompHab_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= "_app_PartPistaCompHab";
      $this->arquivo   .= ".xls";
   ...
   function grava_arquivo()
   {
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['order_grid'];
   ...
   {
         $this->xls_dados->write_string($this->xls_row, $this->xls_col, $this->participante);
         $this->xls_col++;
   }
   //----- pista
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas do Participante por Competência e Habilidade :: Excel</TITLE>
...
<FORM name="F0" method=post action="app_PartPistaCompHab.php"> 
