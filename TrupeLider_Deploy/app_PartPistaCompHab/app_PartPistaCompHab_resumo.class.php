...
class app_PartPistaCompHab_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- Construtor
   function app_PartPistaCompHab_resumo($tipo = "")
   {
   ...
   { 
      ...
      $this->NM_raiz_img = ""; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] == "pdf" && !$this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['print_all'])
      { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['iframe_menu'] && !$this->NM_export)
      {
          $this->aba_iframe = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['array_graf_pdf'] = array();
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['contr_array_resumo'] == "OK")
      {
          $this->array_total_participante = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['arr_total']['participante'];
          $this->array_total_pista = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['arr_total']['pista'];
          $this->array_total_competencia = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['arr_total']['competencia'];
      }
      else
      {
          $this->totaliza();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['arr_total']['participante'] = $this->array_total_participante;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['arr_total']['pista'] = $this->array_total_pista;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['arr_total']['competencia'] = $this->array_total_competencia;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      if ($this->NM_export)
      {
          return;
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] == "pdf" || $this->Print_All)
   {
   ...
   function inicializa_vars()
   {
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] = "print";
      ...
      $this->total   = new app_PartPistaCompHab_total($this->Ini->sc_page);
   ...
   function verifica_impressao()
   {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] == "print" && $nmgp_cor_print == "PB") || $nmgp_tipo_pdf == "pb")
      {
   ...
   function totaliza()
   {
      $this->total->resumo("res", $this->array_total_participante, $this->array_total_pista, $this->array_total_competencia);
      ksort($this->array_total_participante);
      ksort($this->array_total_pista);
      ksort($this->array_total_competencia);
   }
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['print_all'])
       {
   ...
   function monta_cabecalho()
   {
      ...
      $nm_saida->saida("        <TD align=\"left\"><FONT size=\"" . $this->Ini->cab_fonte_tamanho . "\" color=\"" . $this->Ini->cor_txt_cab_grid . "\" face=\"" . $this->Ini->cab_fonte_tipo . "\"></FONT></TD>\r\n");
      $nm_saida->saida("        <TD style=\"font-size: 5px\">&nbsp; &nbsp;</TD>\r\n");
      $nm_saida->saida("        <TD align=\"center\"><FONT size=\"" . $this->Ini->cab_fonte_tamanho . "\" color=\"" . $this->Ini->cor_txt_cab_grid . "\" face=\"" . $this->Ini->cab_fonte_tipo . "\">Relatório das Notas do Participante por Competência e Habilidade</FONT></TD>\r\n");
      $nm_saida->saida("        <TD style=\"font-size: 5px\">&nbsp; &nbsp;</TD>\r\n");
      $nm_saida->saida("        <TD align=\"right\"><FONT size=\"" . $this->Ini->cab_fonte_tamanho . "\" color=\"" . $this->Ini->cor_txt_cab_grid . "\" face=\"" . $this->Ini->cab_fonte_tipo . "\"></FONT></TD>\r\n");
      $nm_saida->saida("       </TR>\r\n");
      $nm_saida->saida("       <TR valign=\"middle\">\r\n");
   ...
   function monta_titulo()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_PartPistaCompHab.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=0&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['array_graf_pdf'][] = array("0" => 0, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_PartPistaCompHab.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=1&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['array_graf_pdf'][] = array("0" => 1, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_PartPistaCompHab.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=2&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['array_graf_pdf'][] = array("0" => 2, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_PartPistaCompHab.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=3&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['array_graf_pdf'][] = array("0" => 3, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_PartPistaCompHab.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=4&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['array_graf_pdf'][] = array("0" => 4, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
   }
         ...
         foreach ($this->array_total_participante as $campo_participante => $dados_participante)
         {
            ...
            if (isset($this->array_total_pista[$campo_participante]))
            {
               foreach ($this->array_total_pista[$campo_participante] as $campo_pista => $dados_pista)
               {
                  ...
                  $this->monta_linha($dados_pista[5], 1, "normal", "&participante=" . urlencode($val_grafico_participante) . "&pista=" . urlencode($val_grafico_pista) . "");
                  if (isset($this->array_total_competencia[$campo_participante][$campo_pista]))
                  {
                     foreach ($this->array_total_competencia[$campo_participante][$campo_pista] as $campo_competencia => $dados_competencia)
                     {
   ...
   function monta_linha($campo, $nivel, $weight, $params, $geral="N")
   {
      ...
      $img_html = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "print" && 2 > $nivel && $params != "nao" && (1 == ($nivel + 1) || 2 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_PartPistaCompHab.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=0&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['array_graf_pdf'][] = array("0" => 0, "1" => $nivel + 1, "2" => $params);
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "print" && 2 > $nivel && $params != "nao" && (1 == ($nivel + 1) || 2 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_PartPistaCompHab.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=1&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['array_graf_pdf'][] = array("0" => 1, "1" => $nivel + 1, "2" => $params);
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "print" && 2 > $nivel && $params != "nao" && (1 == ($nivel + 1) || 2 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_PartPistaCompHab.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=2&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['array_graf_pdf'][] = array("0" => 2, "1" => $nivel + 1, "2" => $params);
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "print" && 2 > $nivel && $params != "nao" && (1 == ($nivel + 1) || 2 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_PartPistaCompHab.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=3&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['array_graf_pdf'][] = array("0" => 3, "1" => $nivel + 1, "2" => $params);
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "print" && 2 > $nivel && $params != "nao" && (1 == ($nivel + 1) || 2 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_PartPistaCompHab.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=4&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['array_graf_pdf'][] = array("0" => 4, "1" => $nivel + 1, "2" => $params);
      }
   ...
   function monta_geral()
   {
      ...
      $this->resumo_campos = array();
      for ($i = 1; $i <= sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['tot_geral']); $i++)
      {
         $this->resumo_campos[] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['tot_geral'][$i];
      }
   ...
   function adiciona_registro($sum_nota_media, $sum_resultado_medio, $sum_total_nota, $sum_total_resultado, $quebra_participante, $quebra_pista, $quebra_competencia, $quebra_participante_orig, $quebra_pista_orig, $quebra_competencia_orig)
   {
      //----- Participante
      if (!isset($this->array_total_participante[$quebra_participante]))
      {
         $this->array_total_participante[$quebra_participante][0] = 1;
         $this->array_total_participante[$quebra_participante][1] = $sum_nota_media;
         $this->array_total_participante[$quebra_participante][2] = $sum_resultado_medio;
         $this->array_total_participante[$quebra_participante][3] = $sum_total_nota;
         $this->array_total_participante[$quebra_participante][4] = $sum_total_resultado;
         $this->array_total_participante[$quebra_participante][5] = $quebra_participante;
         $this->array_total_participante[$quebra_participante][6] = $quebra_participante_orig;
      }
      else
      {
         $this->array_total_participante[$quebra_participante][0]++;
         $this->array_total_participante[$quebra_participante][1] += $sum_nota_media;
         $this->array_total_participante[$quebra_participante][2] += $sum_resultado_medio;
         $this->array_total_participante[$quebra_participante][3] += $sum_total_nota;
         $this->array_total_participante[$quebra_participante][4] += $sum_total_resultado;
      ...
      //----- Pista
      if (!isset($this->array_total_pista[$quebra_participante][$quebra_pista]))
      {
         $this->array_total_pista[$quebra_participante][$quebra_pista][0] = 1;
         $this->array_total_pista[$quebra_participante][$quebra_pista][1] = $sum_nota_media;
         $this->array_total_pista[$quebra_participante][$quebra_pista][2] = $sum_resultado_medio;
         $this->array_total_pista[$quebra_participante][$quebra_pista][3] = $sum_total_nota;
         $this->array_total_pista[$quebra_participante][$quebra_pista][4] = $sum_total_resultado;
         $this->array_total_pista[$quebra_participante][$quebra_pista][5] = $quebra_pista;
         $this->array_total_pista[$quebra_participante][$quebra_pista][6] = $quebra_pista_orig;
      }
      else
      {
         $this->array_total_pista[$quebra_participante][$quebra_pista][0]++;
         $this->array_total_pista[$quebra_participante][$quebra_pista][1] += $sum_nota_media;
         $this->array_total_pista[$quebra_participante][$quebra_pista][2] += $sum_resultado_medio;
         $this->array_total_pista[$quebra_participante][$quebra_pista][3] += $sum_total_nota;
         $this->array_total_pista[$quebra_participante][$quebra_pista][4] += $sum_total_resultado;
      ...
      //----- Competência
      if (!isset($this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia]))
      {
         $this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia][0] = 1;
         $this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia][1] = $sum_nota_media;
         $this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia][2] = $sum_resultado_medio;
         $this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia][3] = $sum_total_nota;
         $this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia][4] = $sum_total_resultado;
         $this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia][5] = $quebra_competencia;
         $this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia][6] = $quebra_competencia_orig;
      }
      else
      {
         $this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia][0]++;
         $this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia][1] += $sum_nota_media;
         $this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia][2] += $sum_resultado_medio;
         $this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia][3] += $sum_total_nota;
         $this->array_total_competencia[$quebra_participante][$quebra_pista][$quebra_competencia][4] += $sum_total_resultado;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->participante = $rs_res->fields[0] ;  
            ...
            $this->participante_orig = $this->participante;
            $this->pista_orig = $this->pista;
            $this->competencia_orig = $this->competencia;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->nota_media, $this->resultado_medio, $this->total_nota, $this->total_resultado, $this->participante, $this->pista, $this->competencia, $this->participante_orig,  $this->pista_orig,  $this->competencia_orig);
            }
   }
//
