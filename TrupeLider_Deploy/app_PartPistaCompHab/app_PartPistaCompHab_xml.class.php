...
class app_PartPistaCompHab_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- Construtor
   function app_PartPistaCompHab_xml()
   {
   ...
   function grava_arquivo()
   {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<app_PartPistaCompHab";
   ...
   {
         $this->xml_registro .= " participante =\"" . $this->trata_dados($this->participante) . "\"";
   }
   //----- pista
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas do Participante por Competência e Habilidade :: XML</TITLE>
