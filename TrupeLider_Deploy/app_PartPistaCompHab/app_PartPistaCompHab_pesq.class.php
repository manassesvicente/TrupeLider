...
class app_PartPistaCompHab_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function app_PartPistaCompHab_pesq()
   {
   }
   ...
   function processa_ajax()
   {
      ...
      if (isset($this->NM_ajax_info['param']['habilidade_cond']))
      {
          $habilidade_cond = $this->NM_ajax_info['param']['habilidade_cond'];
      }
      if (isset($this->NM_ajax_info['param']['habilidade']))
      {
          $habilidade = $this->NM_ajax_info['param']['habilidade'];
      }
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "PART_PISTA_COMP_HAB.$nome";
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // Exatamente igual
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // In&iacute;cio igual
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " iniciando por " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // Qualquer parte
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " que contenha " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= " " . $nome_sum . " like '%" . $campo . "%'";
                   $this->comando_filtro .= " " . $nome . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " que contenha " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // Diferente
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " diferente de " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // Maior que
               $this->comando        .= " $nome > " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum > " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome > " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " maior que " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // Maior ou igual
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " maior ou igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // Menor que
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " menor que " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // Menor ou igual
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " menor ou igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // Entre dois valores
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " entre " . $this->cmp_formatado[$nome_campo] . " e " . $this->cmp_formatado[$nome_campo . "2"] . "##*@@";
                   }
               }
            break;
            ...
            case "NU":     // Conte&uacute;do nulo
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " Conte&uacute;do nulo " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // Conte&uacute;do n&atilde;o nulo
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " Conte&uacute;do n&atilde;o nulo " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "app_PartPistaCompHab.php";
?>
<HTML>
<HEAD>
 <TITLE>Filtro para app_PartPistaCompHab</TITLE>
...
<HEAD>
 <TITLE>Filtro para app_PartPistaCompHab</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
<SCRIPT language="javascript" src="app_PartPistaCompHab_digita.js" ?>">
</SCRIPT>
<SCRIPT language="javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>">
</SCRIPT>
<SCRIPT language="javascript" src="app_PartPistaCompHab_tab_erro.js">
</SCRIPT>
 <SCRIPT language="javascript">
var NM_index = 0;
...
function NM_hide_menu()
{
 ...
 function nm_save_form()
 {
  ...
  app_PartPistaCompHab_do_ajax_save_filter();
 }
 function nm_submit_filter(obj_sel)
 {
  ...
  app_PartPistaCompHab_do_ajax_change_filter();
 }
 function nm_submit_filter_del()
 {
  ...
  app_PartPistaCompHab_do_ajax_delete_filter();
 }
 </SCRIPT>
<?php
include_once("app_PartPistaCompHab_sajax_js.php");
?>
</HEAD>
<BODY>
 <FORM name="F1" action="app_PartPistaCompHab.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page; ?>"> 
...
<?php
   ...
   {
?>
   <FORM name="form_cancel"  method="POST" action="app_PartPistaCompHab.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page; ?>"> 
      ...
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
       <TR valign="middle">
        ...
        <TD align="right" class="css_cabecalho">
          Filtro para app_PartPistaCompHab
        </TD>
       </TR>
       <TR valign="middle">
        <TD align="left" class="css_cabecalho">
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          $participante = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['participante']; 
          $participante_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['participante_cond']; 
          $pista = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['pista']; 
          $pista_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['pista_cond']; 
          $competencia = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['competencia']; 
          $competencia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['competencia_cond']; 
          $habilidade = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['habilidade']; 
          $habilidade_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['habilidade_cond']; 
          $nota_media = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['nota_media']; 
          $nota_media_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['nota_media_cond']; 
          $resultado_medio = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['resultado_medio']; 
          $resultado_medio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['resultado_medio_cond']; 
          $total_nota = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['total_nota']; 
          $total_nota_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['total_nota_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($habilidade_cond) || empty($habilidade_cond))
      {
         $habilidade_cond = "eq";
      }
      ...
      if (isset($habilidade) && !empty($habilidade))
      {
         $tmp_pos = strpos($habilidade, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $habilidade = substr($habilidade, 0, $tmp_pos);
         }
      }
...
<INPUT  type="text" name="competencia" value="<?php echo $competencia ?>"   size="35" style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
     ...
     <TD class="css_lab_par">
        <?php echo (isset($this->New_label['habilidade'])) ? $this->New_label['habilidade'] : "Habilidade"; ?>
     </TD>
     <TD class="css_cmp_par"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="habilidade_cond">
       <OPTION value="eq" <?php if ("eq" == $habilidade_cond) { echo "selected"; } ?>>Exatamente igual</OPTION>
       <OPTION value="ii" <?php if ("ii" == $habilidade_cond) { echo "selected"; } ?>>In&iacute;cio igual</OPTION>
       <OPTION value="qp" <?php if ("qp" == $habilidade_cond) { echo "selected"; } ?>>Qualquer parte</OPTION>
       <OPTION value="df" <?php if ("df" == $habilidade_cond) { echo "selected"; } ?>>Diferente</OPTION>
      </SELECT>
       </TD>
     <TD  class="css_cmp_par">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "habilidade?#?" . $SC_Label . "?@?";
?>
<INPUT  type="text" name="habilidade" value="<?php echo $habilidade ?>"   size="35" style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_PartPistaCompHab']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app_PartPistaCompHab']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
       $NM_fil_ant = array();
       $NM_patch   = "SISTEMA/app_PartPistaCompHab";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      { 
          ...
          $NM_temp  = (isset($habilidade)) ? $habilidade : ""; 
          $NM_str_filter .= "habilidade#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($habilidade_cond)) ? $habilidade_cond : ""; 
          $NM_str_filter .= "habilidade_cond#NMF#" . $NM_temp . "@NMF@"; 
   ...
   function recupera_filtro()
   {
      ...
      $tp_html['habilidade_cond'] = 'select';
   ...
   function trata_campos()
   {
      global $participante_cond, $participante,
             ...
             $nota_media_cond, $nota_media,
             $resultado_medio_cond, $resultado_medio,
             $total_nota_cond, $total_nota, $nmgp_tab_label;
      ...
      $habilidade_cond_salva = $habilidade_cond; 
      if (!isset($habilidade_input_2) || $habilidade_input_2 == "")
      {
          $habilidade_input_2 = $habilidade;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['participante'] = $participante; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['participante_cond'] = $participante_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['pista'] = $pista; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['pista_cond'] = $pista_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['competencia'] = $competencia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['competencia_cond'] = $competencia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['habilidade'] = $habilidade; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['habilidade_cond'] = $habilidade_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['nota_media'] = $nota_media; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['nota_media_cond'] = $nota_media_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['resultado_medio'] = $resultado_medio; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['resultado_medio_cond'] = $resultado_medio_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['total_nota'] = $total_nota; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['total_nota_cond'] = $total_nota_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['campos_busca']['NM_operador'] = $this->NM_operador; 
      ...
      $Conteudo = $habilidade;
      $this->cmp_formatado['habilidade'] = $Conteudo;
      $Conteudo = $habilidade_input_2;
      $this->cmp_formatado['habilidade2'] = $Conteudo;
      $Conteudo = $nota_media;
      ...
      //----- $habilidade
      if (isset($habilidade) || $habilidade_cond == "nu" || $habilidade_cond == "nn")
      {
         $this->monta_condicao("HABILIDADE", $habilidade_cond, $habilidade, "", "habilidade");
      }
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['where_pesq_lookup'] = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['where_pesq'] = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['where_pesq_salvo'] = $this->comando . $this->comando_fim;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['opcao'] = "pesq";
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['prim_vez'] = "N";
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_PartPistaCompHab']['cond_pesq'] .= $this->NM_operador;
      }
