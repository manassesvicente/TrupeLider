...
class app_GrupoCompetencia_grafico
{
   var $Db;
   var $Ini;
   var $Erro;
   ...
   //---- Construtor
   function app_GrupoCompetencia_grafico()
   {
   ...
   function monta_grafico()
   {
      ...
      {
          $graf_tipo    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_tipo'];
          $graf_alt     = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_alt'];
          $graf_larg    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_larg'];
          $graf_marg    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_margem'];
          $graf_asp     = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_aspec'];
          $graf_preen   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_preencher'];
          $graf_ex_val  = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_exibe_val'];
          $graf_ex_marc = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_exibe_marcas'];
          $this->graf_cor_fundo   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_cor_fundo'];
          $this->graf_cor_margens = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_cor_margens'];
          $this->graf_cor_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_cor_label'];
          $this->graf_cor_valores = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_cor_valores'];
          $this->graf_tipo_marcas = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_tipo_marcas'];
          $this->graf_angulo      = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_angulo'];
   ...
   {
      global 
             $nivel_quebra, $campo, $grupo;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['graf_opc_atual'] == 1)
      {
         $this->sc_graf_sint = true;
      }
      //---- Total
      require_once($this->Ini->path_aplicacao . "app_GrupoCompetencia_total.class.php"); 
      $this->total = new app_GrupoCompetencia_total($this->Ini->sc_page);
      $this->prep_modulos("total");
      //---- Parâmetros
      if (get_magic_quotes_gpc())
      {
         $grupo = stripslashes($grupo);
      }
      $grupo = urldecode($grupo);
      $this->campo = (isset($campo))        ? $campo        : 0;
      $this->nivel = (isset($nivel_quebra)) ? $nivel_quebra : 0;
      $this->grupo = (isset($grupo)) ? $grupo : "";
      //---- Arrays de totais
      ...
      $this->label    = array();
      $this->label[0] = "Grupo";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['contr_label_graf']['grupo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['contr_label_graf']['grupo']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['contr_label_graf']['grupo'];
      }
   }
   ...
   function monta_arrays()
   {
      ...
      $this->total->resumo("gra", $this->array_total_grupo);
      ksort($this->array_total_grupo);
      $this->total->grafico($this->array_label_geral, $this->array_datay_geral, $this->array_total_grupo);
      if ($this->nivel == 0)
      {
   ...
   function grafico_generico($tipo, $width, $height, $margem, $aspecto, $preenche, $exibe_val, $exibe_marc, $datay, $label, $tit_datay, $tit_label, $tit_graf, $tip_pizza = "ABS")
   {
      ...
      if (empty($datay) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['opcao'] == "pdf")
      {
         return;
      }
