...
class app_GrupoCompetencia_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   {
      require_once($this->Ini->path_aplicacao . "app_GrupoCompetencia_resumo.class.php"); 
      $this->nm_data    = new nm_data("pt_br");
      $this->arquivo    = "sc_xml";
      ...
      $this->arquivo   .= ".xml";
      $this->Res       = new app_GrupoCompetencia_resumo("out");
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['arr_total']['grupo'] as $campo_grupo => $dados_grupo)
      {
         $this->resumo_campos = $dados_grupo;
         $this->grava_linha($xml_f, $campo_grupo, 0);
      }
      fwrite($xml_f, "</root>");
      fclose($xml_f);
   }
   ...
   {
      $xml_registro  = "<app_GrupoCompetencia";
