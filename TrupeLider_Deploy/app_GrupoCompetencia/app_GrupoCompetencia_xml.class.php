...
class app_GrupoCompetencia_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- Construtor
   function app_GrupoCompetencia_xml()
   {
   ...
   function grava_arquivo()
   {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<app_GrupoCompetencia";
...
<HTML>
<HEAD>
 <TITLE>Relatório de Notas das Competências por Grupo :: XML</TITLE>
