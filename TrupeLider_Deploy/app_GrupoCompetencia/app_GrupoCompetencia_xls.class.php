...
class app_GrupoCompetencia_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $arquivo;
   //---- Construtor
   function app_GrupoCompetencia_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= "_app_GrupoCompetencia";
      $this->arquivo   .= ".xls";
   ...
   function grava_arquivo()
   {
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoCompetencia']['order_grid'];
...
<HTML>
<HEAD>
 <TITLE>Relatório de Notas das Competências por Grupo :: Excel</TITLE>
...
<FORM name="F0" method=post action="app_GrupoCompetencia.php"> 
