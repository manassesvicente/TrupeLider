...
{
?>
 <META http-equiv="Refresh" content="2, url=app_GrupoCompetencia_gauge_ctrl.php?pbfile=<?php echo urlencode($_GET['pbfile']); ?>&sc_apbgcol=<?php echo urlencode($_GET['sc_apbgcol']) ?>">
<?php
}
?>
</HEAD>
