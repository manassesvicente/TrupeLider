<form name="F2" method=post 
               ...
               target="_self"> 
<input type=hidden name="id_participe" value="<?php  echo $this->nmgp_dados_form['id_participe'] ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_Participantes']['parms'] ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page ?>"/> 
</form> 
...
function NM_critica (form, campo, label, mask, tipo, intr, dec, min, max)
{
 ...
 NM_tab_crit[1] = new NM_critica('F1', 'id_grupo', 'Grupo', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit[2] = new NM_critica('F1', 'nome', 'Nome Participante', 'naomask', 'lista', 'cxab', 20, 'TUDO');
 NM_tab_crit[3] = new NM_critica('F1', 'sobrenome', 'Sobrenome', 'naomask', 'lista', 'cxab', 120, 'TUDO');
 NM_tab_crit[4] = new NM_critica('F1', 'cep', 'CEP', 'naomask', 'cep');
 NM_tab_crit[5] = new NM_critica('F1', 'estado', 'Estado', 'naomask', 'lista', 'cxab', 30, 'TUDO');
 NM_tab_crit[6] = new NM_critica('F1', 'cidade', 'Cidade', 'naomask', 'lista', 'cxab', 35, 'TUDO');
 NM_tab_crit[7] = new NM_critica('F1', 'bairro', 'Bairro', 'naomask', 'lista', 'cxab', 25, 'TUDO');
 NM_tab_crit[8] = new NM_critica('F1', 'logradouro', 'Endereço', 'naomask', 'lista', 'cxab', 200, 'TUDO');
 NM_tab_crit[9] = new NM_critica('F1', 'numero', 'Número', 'naomask', 'lista', 'cxab', 6, 'TUDO');
 NM_tab_crit[10] = new NM_critica('F1', 'complemento', 'Complemento', 'naomask', 'lista', 'cxab', 50, 'TUDO');
 NM_tab_crit[11] = new NM_critica('F1', 'email', 'E-mail', 'naomask', 'email', 50);
 NM_tab_crit[12] = new NM_critica('F1', 'telefax', 'Telefone / Fax', 'naomask', 'lista', 'cxab', 40, 'TUDO');
 NM_tab_crit[13] = new NM_critica('F1', 'tel', 'Celular', 'naomask', 'lista', 'cxab', 40, 'TUDO');
 NM_tab_crit[14] = new NM_critica('F1', 'obs', 'Observações', 'naomask', 'lista', 'cxab', 250, 'TUDO');
 NM_tab_crit[15] = new NM_critica('NM_final');
 NM_tab_crit_1 = new NM_critica(15);
 NM_tab_crit_1[1] = new NM_critica('F1', 'id_grupo', 'Grupo', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit_1[2] = new NM_critica('F1', 'nome', 'Nome Participante', 'naomask', 'lista', 'cxab', 20, 'TUDO');
 NM_tab_crit_1[3] = new NM_critica('F1', 'sobrenome', 'Sobrenome', 'naomask', 'lista', 'cxab', 120, 'TUDO');
 NM_tab_crit_1[4] = new NM_critica('F1', 'cep', 'CEP', 'naomask', 'cep');
 NM_tab_crit_1[5] = new NM_critica('F1', 'estado', 'Estado', 'naomask', 'lista', 'cxab', 30, 'TUDO');
 NM_tab_crit_1[6] = new NM_critica('F1', 'cidade', 'Cidade', 'naomask', 'lista', 'cxab', 35, 'TUDO');
 NM_tab_crit_1[7] = new NM_critica('F1', 'bairro', 'Bairro', 'naomask', 'lista', 'cxab', 25, 'TUDO');
 NM_tab_crit_1[8] = new NM_critica('F1', 'logradouro', 'Endereço', 'naomask', 'lista', 'cxab', 200, 'TUDO');
 NM_tab_crit_1[9] = new NM_critica('F1', 'numero', 'Número', 'naomask', 'lista', 'cxab', 6, 'TUDO');
 NM_tab_crit_1[10] = new NM_critica('F1', 'complemento', 'Complemento', 'naomask', 'lista', 'cxab', 50, 'TUDO');
 NM_tab_crit_1[11] = new NM_critica('F1', 'email', 'E-mail', 'naomask', 'email', 50);
 NM_tab_crit_1[12] = new NM_critica('F1', 'telefax', 'Telefone / Fax', 'naomask', 'lista', 'cxab', 40, 'TUDO');
 NM_tab_crit_1[13] = new NM_critica('F1', 'tel', 'Celular', 'naomask', 'lista', 'cxab', 40, 'TUDO');
 NM_tab_crit_1[14] = new NM_critica('F1', 'obs', 'Observações', 'naomask', 'lista', 'cxab', 250, 'TUDO');
...
function cep_cep(num_cep, campos_cep)
{
   ...
   jsrsExecute("app_Participantes_cep.php?cep=" + num_cep + "&onchange=s", recebe_cep, "cep", num_cep, false);
}
