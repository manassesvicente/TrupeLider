...
function CriticaCampos()
{
  ...
  {
    alert("Informe o nome da avenida, alameda, beco, passagem, praÁa, rua, travessa etc. N„o informe o n˙mero da casa/lote/apartamento.");
   ...
   else
   {
       if (Cont <= 2)
       {
          ...
          {
             alert("Na opÁ„o COME«ANDO COM, informe no mÌnimo 3 caracteres !!");
             document.Geral.Logradouro.focus();
             return (false);
          }
          else
             ...
             {
                alert("Na opÁ„o CONTENHA, informe no mÌnimo 3 caracteres !!");
                document.Geral.Logradouro.focus();
                return (false);
             }
             else
                ...
                {
                   alert("Na opÁ„o TERMINADO EM, informe no mÌnimo 3 caracteres !!");
                   document.Geral.Logradouro.focus();
                   return (false);
                }
       }
...
//   DocRemote = window.open ('http://www.correios.com.br/servicos/cep/AjudaLogradouro.cfm','Logradouro','scrollbars,resizable,width=410,height=220');
     alert("Informe o nome da avenida, alameda, beco, passagem, praÁa, rua, travessa etc. N„o informe o n˙mero da casa/lote/apartamento. N„o informe o tipo (avenida, rua, etc) nem o tÌtulo ou patente (coronel, tenente, doutor, etc.)");
     document.Geral.Logradouro.focus();
 }
...
<table width="392" height="190" background="">
  ...
  <tr>
    <td width="88" height="25"><select name="Tipo" class="nm_input">
        ...
        <option value="PraÁa">PraÁa</option>
        <option value="Quadra">Quadra</option>
        <option value="Rua">Rua</option>
        <option value="Outros">Outros</option>
        </select></td>
   <td width="293" height="25"><input align="left" maxLength="60" name="Logradouro" size="40" class="nm_input" title="Informe o nome da avenida, alameda, beco, passagem, praÁa, rua, travessa etc.
...
<table>
  <tr>
    <td width="88" height="42"><b><font face="Tahoma, Arial, sans-serif" size="2">OpÁıes:</font></b></td>
    <td width="293" height="42">
      ...
      <input  name="Opcao" type="radio" value="Comecando" title="Pesquisar os logradouros que comecem com o argumento fornecido."> <b><font face="Tahoma, Arial, sans-serif" size="2">ComeÁando por</font></b>
    </td>
  </tr>
  <tr>
    <td></td>
