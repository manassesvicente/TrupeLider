...
class app_LiderPista_resumo
{
   ...
   //---- Construtor
   function app_LiderPista_resumo($tipo = "")
   {
   ...
   { 
      ...
      $this->NM_raiz_img = ""; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] == "pdf" && !$this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['print_all'])
      { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['iframe_menu'] && !$this->NM_export)
      {
          $this->aba_iframe = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['array_graf_pdf'] = array();
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['contr_array_resumo'] == "OK")
      {
          $this->array_total_lider = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['arr_total']['lider'];
      }
      else
      {
          $this->totaliza();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['arr_total']['lider'] = $this->array_total_lider;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      if ($this->NM_export)
      {
          return;
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] == "pdf" || $this->Print_All)
   {
   ...
   function inicializa_vars()
   {
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] = "print";
   ...
   function verifica_impressao()
   {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] == "print" && $nmgp_cor_print == "PB") || $nmgp_tipo_pdf == "pb")
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['print_all'])
       {
   ...
   function monta_titulo()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderPista.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=0&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['array_graf_pdf'][] = array("0" => 0, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderPista.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=1&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['array_graf_pdf'][] = array("0" => 1, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderPista.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=2&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['array_graf_pdf'][] = array("0" => 2, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderPista.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=3&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['array_graf_pdf'][] = array("0" => 3, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderPista.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=4&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['array_graf_pdf'][] = array("0" => 4, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
   }
   ...
   function monta_geral()
   {
      ...
      $this->resumo_campos = array();
      for ($i = 1; $i <= sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['tot_geral']); $i++)
      {
         $this->resumo_campos[] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['tot_geral'][$i];
      }
