...
class app_LiderPista_xls
{
   ...
   function grava_arquivo()
   {
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPista']['order_grid'];
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas do Líder por Pista :: Excel</TITLE>
