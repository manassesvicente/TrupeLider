...
class app_LiderCompetencias_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- Construtor
   function app_LiderCompetencias_resumo($tipo = "")
   {
   ...
   { 
      ...
      $this->NM_raiz_img = ""; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] == "pdf" && !$this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['print_all'])
      { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['iframe_menu'] && !$this->NM_export)
      {
          $this->aba_iframe = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['array_graf_pdf'] = array();
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['contr_array_resumo'] == "OK")
      {
          $this->array_total_lider = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['arr_total']['lider'];
      }
      else
      {
          $this->totaliza();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['arr_total']['lider'] = $this->array_total_lider;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      if ($this->NM_export)
      {
          return;
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] == "pdf" || $this->Print_All)
   {
   ...
   function inicializa_vars()
   {
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] = "print";
      ...
      $this->total   = new app_LiderCompetencias_total($this->Ini->sc_page);
   ...
   function verifica_impressao()
   {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] == "print" && $nmgp_cor_print == "PB") || $nmgp_tipo_pdf == "pb")
      {
   ...
   function totaliza()
   {
      $this->total->resumo("res", $this->array_total_lider);
      ksort($this->array_total_lider);
   }
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['print_all'])
       {
   ...
   function monta_titulo()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderCompetencias.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=0&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['array_graf_pdf'][] = array("0" => 0, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderCompetencias.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=1&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['array_graf_pdf'][] = array("0" => 1, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderCompetencias.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=2&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['array_graf_pdf'][] = array("0" => 2, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderCompetencias.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=3&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['array_graf_pdf'][] = array("0" => 3, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderCompetencias.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=4&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['array_graf_pdf'][] = array("0" => 4, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
   }
   ...
   function monta_corpo()
   {
      if (isset($this->array_total_lider))
      {
         foreach ($this->array_total_lider as $campo_lider => $dados_lider)
         {
            ...
            $this->monta_linha($dados_lider[5], 0, "normal", "");
         } // foreach lider
      } // isset lider
   }
   ...
   function monta_geral()
   {
      ...
      $this->resumo_campos = array();
      for ($i = 1; $i <= sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['tot_geral']); $i++)
      {
         $this->resumo_campos[] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['tot_geral'][$i];
      }
   ...
   function adiciona_registro($sum_nota_media, $sum_resultado_medio, $sum_total_nota, $sum_total_resultado, $quebra_lider, $quebra_lider_orig)
   {
      //----- Líder
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->nota_media, $this->resultado_medio, $this->total_nota, $this->total_resultado, $this->lider, $this->lider_orig);
            }
   }
//
