<?php
//--- Processa Detalhe
class app_LiderCompetencias_det
{
   var $Ini;
   var $Erro;
   var $Db;
 ...
 function monta_det()
 {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] = $GLOBALS['nmgp_opcao'];
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['chave_det'] = $GLOBALS['nmgp_chave_det'];
   ...
   $parms_det = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['chave_det']) ; 
   ...
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
   {
       ...
       { 
           $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['where_pesq'] . " and " ;  
       } 
       else 
       { 
           $nmgp_select .= " where " ;  
   ...
   { 
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['where_pesq'])) 
       { 
          $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['where_pesq'] . " and  LIDER = '$parms_det[0]' and COMPETENCIA = '$parms_det[1]' and NOTA_MEDIA = $parms_det[2] and RESULTADO_MEDIO = $parms_det[3] and TOTAL_NOTA = $parms_det[4] and TOTAL_RESULTADO = $parms_det[5]" ;  
       } 
       else 
       { 
          $nmgp_select .= " where  LIDER = '$parms_det[0]' and COMPETENCIA = '$parms_det[1]' and NOTA_MEDIA = $parms_det[2] and RESULTADO_MEDIO = $parms_det[3] and TOTAL_NOTA = $parms_det[4] and TOTAL_RESULTADO = $parms_det[5]" ;  
       } 
   } 
   ...
   $this->competencia = $rs->fields[1] ;  
   $this->nota_media = $rs->fields[2] ;  
   $this->nota_media = (string)$this->nota_media;
   $this->resultado_medio = $rs->fields[3] ;  
   $this->resultado_medio = (string)$this->resultado_medio;
   $this->total_nota = $rs->fields[4] ;  
   $this->total_nota = (string)$this->total_nota;
   $this->total_resultado = $rs->fields[5] ;  
   $this->total_resultado = (string)$this->total_resultado;
//--- 
   $nm_saida->saida("<html>\r\n");
   $nm_saida->saida("<HEAD>\r\n");
   $nm_saida->saida("   <TITLE>Detalhes de app_LiderCompetencias</TITLE>\r\n");
   ...
   $nm_saida->saida("        <TD style=\"font-size: 5px\">&nbsp; &nbsp;</TD>\r\n");
   $nm_saida->saida("        <TD align=\"right\"><FONT size=\"" . $this->Ini->cab_fonte_tamanho . "\" color=\"" . $this->Ini->cor_txt_cab_grid . "\" face=\"" . $this->Ini->cab_fonte_tipo . "\">Detalhes de app_LiderCompetencias</FONT></TD>\r\n");
   $nm_saida->saida("       </TR>\r\n");
   $nm_saida->saida("       <TR valign=\"middle\">\r\n");
   $nm_saida->saida("        <TD align=\"left\"><FONT size=\"" . $this->Ini->cab_fonte_tamanho . "\" color=\"" . $this->Ini->cor_txt_cab_grid . "\" face=\"" . $this->Ini->cab_fonte_tipo . "\"></FONT></TD>\r\n");
   $nm_saida->saida("        <TD style=\"font-size: 5px\">&nbsp; &nbsp;</TD>\r\n");
...
//--- Formulário para controle da navegação
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"app_LiderCompetencias_doc.php?script_case_init=" . $this->Ini->sc_page . "&nm_cod_doc=\" + campo1 + \"&nm_nome_doc=\" + campo2 + \"&nm_cod_apl=\" + campo3, \"ScriptCase\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
