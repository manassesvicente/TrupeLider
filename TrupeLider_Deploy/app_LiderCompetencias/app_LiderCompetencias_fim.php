...
//----- Limpa variável de segurança
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_LiderCompetencias"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_LiderCompetencias"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_LiderCompetencias']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['app_LiderCompetencias']['opc_psq']) || $fecha_janela)
   {
...
<HTML>
<HEAD>
 <TITLE>app_LiderCompetencias</TITLE>
