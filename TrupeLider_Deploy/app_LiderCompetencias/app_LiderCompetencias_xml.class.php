...
class app_LiderCompetencias_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- Construtor
   function app_LiderCompetencias_xml()
   {
   ...
   function grava_arquivo()
   {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<app_LiderCompetencias";
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas do Líder por Competência :: XML</TITLE>
