...
class app_LiderCompetencias_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- Construtor
   function app_LiderCompetencias_csv()
   {
   ...
   function grava_arquivo()
   {
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['order_grid'];
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas do Líder por Competência :: CSV</TITLE>
