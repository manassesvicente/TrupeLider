...
class app_LiderCompetencias_grafico
{
   var $Db;
   var $Ini;
   var $Erro;
   ...
   //---- Construtor
   function app_LiderCompetencias_grafico()
   {
   ...
   function monta_grafico()
   {
      ...
      {
          $graf_tipo    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_tipo'];
          $graf_alt     = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_alt'];
          $graf_larg    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_larg'];
          $graf_marg    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_margem'];
          $graf_asp     = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_aspec'];
          $graf_preen   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_preencher'];
          $graf_ex_val  = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_exibe_val'];
          $graf_ex_marc = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_exibe_marcas'];
          $this->graf_cor_fundo   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_cor_fundo'];
          $this->graf_cor_margens = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_cor_margens'];
          $this->graf_cor_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_cor_label'];
          $this->graf_cor_valores = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_cor_valores'];
          $this->graf_tipo_marcas = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_tipo_marcas'];
          $this->graf_angulo      = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_angulo'];
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['graf_opc_atual'] == 1)
      {
         $this->sc_graf_sint = true;
      }
      //---- Total
      require_once($this->Ini->path_aplicacao . "app_LiderCompetencias_total.class.php"); 
      ...
      $this->label    = array();
      $this->label[0] = "Líder";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['contr_label_graf']['lider']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['contr_label_graf']['lider']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['contr_label_graf']['lider'];
      }
   }
   ...
   function grafico_generico($tipo, $width, $height, $margem, $aspecto, $preenche, $exibe_val, $exibe_marc, $datay, $label, $tit_datay, $tit_label, $tit_graf, $tip_pizza = "ABS")
   {
      ...
      if (empty($datay) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderCompetencias']['opcao'] == "pdf")
      {
         return;
      }
