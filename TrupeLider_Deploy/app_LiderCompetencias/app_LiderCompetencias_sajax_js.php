  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_LiderCompetencias" == sTestField)
        {
...
//      document.F1.elements[sFieldName].value = scAjaxSpecCharParser(sFieldValue);
  ...
  // ---------- save_filter
  function app_LiderCompetencias_do_ajax_save_filter()
  {
    ...
    x_app_LiderCompetencias_ajax_save_filter( var_lider_cond, var_lider, var_competencia_cond, var_competencia, var_nota_media_cond, var_nota_media, var_resultado_medio_cond, var_resultado_medio, var_total_nota_cond, var_total_nota, var_total_resultado_cond, var_total_resultado, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, app_LiderCompetencias_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function app_LiderCompetencias_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function app_LiderCompetencias_do_ajax_change_filter()
  {
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters");
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_app_LiderCompetencias_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, app_LiderCompetencias_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function app_LiderCompetencias_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
  ...
  // ---------- delete_filter
  function app_LiderCompetencias_do_ajax_delete_filter()
  {
    var var_NM_filters_del = scAjaxGetFieldSelect("NM_filters_del");
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_app_LiderCompetencias_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, app_LiderCompetencias_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function app_LiderCompetencias_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    document.F1.NM_filters.selectedIndex = -1;
  ...
  ajax_field_list[1] = "competencia";
  ajax_field_list[2] = "nota_media";
  ajax_field_list[3] = "resultado_medio";
  ajax_field_list[4] = "total_nota";
  ajax_field_list[5] = "total_resultado";
