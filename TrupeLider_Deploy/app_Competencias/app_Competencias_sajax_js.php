  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_Competencias" == sTestField)
        {
...
//      document.F1.elements[sFieldName].value = scAjaxSpecCharParser(sFieldValue);
  ...
  // ---------- Validate cod_competencia
  function do_ajax_app_Competencias_validate_cod_competencia()
  {
    var nomeCampo_cod_competencia = "cod_competencia";
    var var_cod_competencia = scAjaxGetFieldText(nomeCampo_cod_competencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Competencias_validate_cod_competencia(var_cod_competencia, var_script_case_init, do_ajax_app_Competencias_validate_cod_competencia_cb);
  } // do_ajax_app_Competencias_validate_cod_competencia

  function do_ajax_app_Competencias_validate_cod_competencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cod_competencia";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Competencias_validate_cod_competencia_cb

  // ---------- Validate descricao
  function do_ajax_app_Competencias_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Competencias_validate_descricao(var_descricao, var_script_case_init, do_ajax_app_Competencias_validate_descricao_cb);
  } // do_ajax_app_Competencias_validate_descricao

  function do_ajax_app_Competencias_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Competencias_validate_descricao_cb

  // ---------- Validate obs
  function do_ajax_app_Competencias_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Competencias_validate_obs(var_obs, var_script_case_init, do_ajax_app_Competencias_validate_obs_cb);
  } // do_ajax_app_Competencias_validate_obs

  function do_ajax_app_Competencias_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "obs";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Competencias_validate_obs_cb
  // ---------- Form
  function do_ajax_app_Competencias_submit_form()
  {
    scAjaxHideMessage();
    var var_cod_competencia = scAjaxGetFieldText("cod_competencia");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_app_Competencias_submit_form(var_cod_competencia, var_descricao, var_obs, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_app_Competencias_submit_form_cb);
  } // do_ajax_app_Competencias_submit_form

  function do_ajax_app_Competencias_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cod_competencia");
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app_Competencias_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_app_Competencias_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("descricao");
    scAjaxHideErrorDisplay("obs");
    var var_id_competencia = document.F2.id_competencia.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_app_Competencias_navigate_form(var_id_competencia, var_nm_form_submit, var_nmgp_opcao, var_script_case_init, do_ajax_app_Competencias_navigate_form_cb);
  } // do_ajax_app_Competencias_navigate_form

  function do_ajax_app_Competencias_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    document.F2.id_competencia.value = scAjaxGetKeyValue("id_competencia");
    scAjaxShowDebug();
...
{
?>
    do_ajax_app_Competencias_restore_buttons();
<?php
}
?>
  } // do_ajax_app_Competencias_navigate_form_cb
  ...
  ajax_field_list[0] = "cod_competencia";
  ...
  var ajax_error_list = {
    "cod_competencia": {"label": "Código da Competência", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descricao": {"label": "Descrição da Competência", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "cod_competencia": new Array(),
    "descricao": new Array(),
    "obs": new Array()
  };
  ajax_field_mult["cod_competencia"][1] = "cod_competencia";
  ajax_field_mult["descricao"][1] = "descricao";
  ajax_field_mult["obs"][1] = "obs";

  var ajax_field_id = {
    "cod_competencia": new Array("hidden_field_label_cod_competencia", "hidden_field_data_cod_competencia"),
