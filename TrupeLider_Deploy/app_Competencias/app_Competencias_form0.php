...
<html>
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo 'CADASTRO DE COMPETÊNCIAS'; } else { echo 'CADASTRO DE COMPETÊNCIAS'; } ?></TITLE>
 ...
 <SCRIPT language="javascript" src="app_Competencias_dynifs.js"></SCRIPT>
<?php
include_once("app_Competencias_sajax_js.php");
?>
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe']) ? 'marginwidth="0" marginheight="0" topmargin="0" leftmargin="0"' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['recarga'];
}
...
<script language="javascript" src="app_Competencias_digita.js"> 
</script> 
<?php
 include_once("app_Competencias_js0.php");
?>
<script language="javascript" src="app_Competencias_tab_erro.js"> 
</script> 
<script language="javascript"> 
 </script>
<form name="F1" method=post 
               action="app_Competencias.php" 
               target="_self"> 
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe']) ? 0 : "3";
?>
<table align="center" cellpadding=<?php echo $int_iframe_padding; ?> cellspacing=0 border=0 align=center >
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['mostra_cab'] != "N"))
  {
?>
<tr><td>
     ...
     <TD>
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
       ...
       <TR valign="middle">
        ...
        <TD align="center" class="css_cabecalho">
          <?php if ($this->nmgp_opcao == "novo") { echo "CADASTRO DE COMPETÊNCIAS"; } else { echo "CADASTRO DE COMPETÊNCIAS"; } ?>
        </TD>
        <TD style="font-size: 5px">
          &nbsp; &nbsp;
        </TD>
...
<tr><td align="center">
<?php
if ((!$this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && ($this->nm_flag_saida_novo == "S" && $this->nmgp_botoes['exit'] == "on") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe'] != "R") && (!$this->Embutida_call)) {
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") && (!$this->Embutida_call)) {
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") && (!$this->Embutida_call)) {
?>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" height="100%"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['cod_competencia']))
    {
        $this->nm_new_label['cod_competencia'] = 'Código da Competência';
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $cod_competencia = $this->cod_competencia;
   $sStyleHidden_cod_competencia = '';
   if (isset($this->nmgp_cmp_hidden['cod_competencia']) && $this->nmgp_cmp_hidden['cod_competencia'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['cod_competencia']);
       $sStyleHidden_cod_competencia = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_cod_competencia = 'display: none;';
   $sStyleReadInp_cod_competencia = '';
   if (isset($this->nmgp_cmp_readonly['cod_competencia']) && $this->nmgp_cmp_readonly['cod_competencia'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['cod_competencia']);
       $sStyleReadLab_cod_competencia = '';
       $sStyleReadInp_cod_competencia = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['cod_competencia']) && $this->nmgp_cmp_hidden['cod_competencia'] == 'off') { $sc_hidden_yes++;  ?>
<input type=hidden name="cod_competencia" value="<?php echo str_replace('"', "&quot;", $cod_competencia) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd" id="hidden_field_label_cod_competencia" style="<?php echo $sStyleHidden_cod_competencia; ?>"><span id="id_label_cod_competencia"><?php echo $this->nm_new_label['cod_competencia']; ?></span>*</TD>
    <TD class="scFormDataOdd" id="hidden_field_data_cod_competencia" style="<?php echo $sStyleHidden_cod_competencia; ?>"><table style="border-width: 0px; border-collapse: collapse"><tr><td  class="scFormDataFontOdd" style="vertical-align: top; padding: 0px">
<?php if ($bTestReadOnly && isset($this->nmgp_cmp_readonly["cod_competencia"]) &&  $this->nmgp_cmp_readonly["cod_competencia"] == "on") { 

 ?>
<input type=hidden name="cod_competencia" value="<?php echo str_replace('"', "&quot;", $cod_competencia) . "\">" . $cod_competencia . ""; ?>
<?php } else { ?>
<span id="id_read_on_cod_competencia" style="<?php echo $sStyleReadLab_cod_competencia; ?>"><?php echo $this->cod_competencia; ?></span><span id="id_read_off_cod_competencia" style="<?php echo $sStyleReadInp_cod_competencia; ?>">
 <input class="scFormObjectOdd" type=text name="cod_competencia" value="<?php echo str_replace('"', "&quot;", $cod_competencia) ?>"
 onblur="scCssBlur(this); NM_onblur(); do_ajax_app_Competencias_validate_cod_competencia(); return false;" onfocus="scCssFocus(this); NM_onfocus(this.form.name, this.name, '<?php echo htmlentities("Código da Competência")?>', 0, 'naomask', 'lista', 'CXA', 20, 'abcdefghijklmnopqrstuvwxyz ')" size=20 maxlength=20></span><?php } ?>
</td><td style="vertical-align: top; padding: 0px 0px 0px 5px"><table class="scErrorTable" style="display: none; position: absolute" id="id_error_display_cod_competencia_frame"><tr><td class="scErrorMessage"><span id="id_error_display_cod_competencia_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['descricao'] = 'Descrição da Competência';
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<span id="id_read_on_descricao" style="<?php echo $sStyleReadLab_descricao; ?>"><?php echo $this->descricao; ?></span><span id="id_read_off_descricao" style="<?php echo $sStyleReadInp_descricao; ?>">
 ...
 onblur="scCssBlur(this); NM_onblur(); do_ajax_app_Competencias_validate_descricao(); return false;" onfocus="scCssFocus(this); NM_onfocus(this.form.name, this.name, '<?php echo htmlentities("Descrição da Competência")?>', 0, 'naomask', 'lista', 'cxab', 120, 'TUDO')" size=40 maxlength=120></span><?php } ?>
...
<span id="id_read_on_obs" style="<?php echo $sStyleReadLab_obs; ?>"><?php echo $obs_val; ?></span><span id="id_read_off_obs" style="<?php echo $sStyleReadInp_obs; ?>">
 ...
 onblur="scCssBlur(this); NM_onblur(); do_ajax_app_Competencias_validate_obs(); return false;" onfocus="scCssFocus(this); NM_onfocus(this.form.name, this.name, '<?php echo htmlentities("Observações")?>', 0, 'naomask', 'lista', 'cxab', 250, 'TUDO')">
...
{
?>
<script>parent.scAjaxDetailStatus("app_Competencias");</script>
<?php
}
?>
<script>
