<form name="F2" method=post 
               ...
               target="_self"> 
<input type=hidden name="id_competencia" value="<?php  echo $this->nmgp_dados_form['id_competencia'] ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_Competencias']['parms'] ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page ?>"/> 
</form> 
...
function NM_critica (form, campo, label, mask, tipo, intr, dec, min, max)
{
 ...
 NM_tab_crit[1] = new NM_critica('F1', 'cod_competencia', 'Código da Competência', 'naomask', 'lista', 'CXA', 20, 'abcdefghijklmnopqrstuvwxyz ');
 NM_tab_crit[2] = new NM_critica('F1', 'descricao', 'Descrição da Competência', 'naomask', 'lista', 'cxab', 120, 'TUDO');
 ...
 NM_tab_crit_1[1] = new NM_critica('F1', 'cod_competencia', 'Código da Competência', 'naomask', 'lista', 'CXA', 20, 'abcdefghijklmnopqrstuvwxyz ');
 NM_tab_crit_1[2] = new NM_critica('F1', 'descricao', 'Descrição da Competência', 'naomask', 'lista', 'cxab', 120, 'TUDO');
