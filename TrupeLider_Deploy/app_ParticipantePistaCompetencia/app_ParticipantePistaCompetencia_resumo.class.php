...
class app_ParticipantePistaCompetencia_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- Construtor
   function app_ParticipantePistaCompetencia_resumo($tipo = "")
   {
   ...
   { 
      ...
      $this->NM_raiz_img = ""; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] == "pdf" && !$this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['print_all'])
      { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['iframe_menu'] && !$this->NM_export)
      {
          $this->aba_iframe = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['array_graf_pdf'] = array();
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['contr_array_resumo'] == "OK")
      {
          $this->array_total_participante = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['arr_total']['participante'];
          $this->array_total_pista = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['arr_total']['pista'];
      }
      else
      {
          $this->totaliza();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['arr_total']['participante'] = $this->array_total_participante;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['arr_total']['pista'] = $this->array_total_pista;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      if ($this->NM_export)
      {
          return;
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] == "pdf" || $this->Print_All)
   {
   ...
   function inicializa_vars()
   {
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] = "print";
      ...
      $this->total   = new app_ParticipantePistaCompetencia_total($this->Ini->sc_page);
   ...
   function verifica_impressao()
   {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] == "print" && $nmgp_cor_print == "PB") || $nmgp_tipo_pdf == "pb")
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['print_all'])
       {
   ...
   function monta_titulo()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_ParticipantePistaCompetencia.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=0&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['array_graf_pdf'][] = array("0" => 0, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_ParticipantePistaCompetencia.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=1&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['array_graf_pdf'][] = array("0" => 1, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_ParticipantePistaCompetencia.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=2&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['array_graf_pdf'][] = array("0" => 2, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_ParticipantePistaCompetencia.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=3&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['array_graf_pdf'][] = array("0" => 3, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_ParticipantePistaCompetencia.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=4&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['array_graf_pdf'][] = array("0" => 4, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
   }
   ...
   function monta_linha($campo, $nivel, $weight, $params, $geral="N")
   {
      ...
      $img_html = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "print" && 1 > $nivel && $params != "nao" && (1 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_ParticipantePistaCompetencia.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=0&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['array_graf_pdf'][] = array("0" => 0, "1" => $nivel + 1, "2" => $params);
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "print" && 1 > $nivel && $params != "nao" && (1 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_ParticipantePistaCompetencia.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=1&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['array_graf_pdf'][] = array("0" => 1, "1" => $nivel + 1, "2" => $params);
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "print" && 1 > $nivel && $params != "nao" && (1 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_ParticipantePistaCompetencia.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=2&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['array_graf_pdf'][] = array("0" => 2, "1" => $nivel + 1, "2" => $params);
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "print" && 1 > $nivel && $params != "nao" && (1 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_ParticipantePistaCompetencia.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=3&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['array_graf_pdf'][] = array("0" => 3, "1" => $nivel + 1, "2" => $params);
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "print" && 1 > $nivel && $params != "nao" && (1 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_ParticipantePistaCompetencia.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=4&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['array_graf_pdf'][] = array("0" => 4, "1" => $nivel + 1, "2" => $params);
      }
   ...
   function monta_geral()
   {
      ...
      $this->resumo_campos = array();
      for ($i = 1; $i <= sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['tot_geral']); $i++)
      {
         $this->resumo_campos[] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['tot_geral'][$i];
      }
   ...
   function adiciona_registro($sum_nota_media, $sum_resultado_medio, $sum_total_nota, $sum_total_resultado, $quebra_participante, $quebra_pista, $quebra_participante_orig, $quebra_pista_orig)
   {
      //----- Participante
      if (!isset($this->array_total_participante[$quebra_participante_orig]))
      {
         $this->array_total_participante[$quebra_participante_orig][0] = 1;
         $this->array_total_participante[$quebra_participante_orig][1] = $sum_nota_media;
         $this->array_total_participante[$quebra_participante_orig][2] = $sum_resultado_medio;
         $this->array_total_participante[$quebra_participante_orig][3] = $sum_total_nota;
         $this->array_total_participante[$quebra_participante_orig][4] = $sum_total_resultado;
         $this->array_total_participante[$quebra_participante_orig][5] = $quebra_participante;
         $this->array_total_participante[$quebra_participante_orig][6] = $quebra_participante_orig;
      }
      else
      {
         $this->array_total_participante[$quebra_participante_orig][0]++;
         $this->array_total_participante[$quebra_participante_orig][1] += $sum_nota_media;
         $this->array_total_participante[$quebra_participante_orig][2] += $sum_resultado_medio;
         $this->array_total_participante[$quebra_participante_orig][3] += $sum_total_nota;
         $this->array_total_participante[$quebra_participante_orig][4] += $sum_total_resultado;
      ...
      //----- Pista
      if (!isset($this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig]))
      {
         $this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig][0] = 1;
         $this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig][1] = $sum_nota_media;
         $this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig][2] = $sum_resultado_medio;
         $this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig][3] = $sum_total_nota;
         $this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig][4] = $sum_total_resultado;
         $this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig][5] = $quebra_pista;
         $this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig][6] = $quebra_pista_orig;
      }
      else
      {
         $this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig][0]++;
         $this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig][1] += $sum_nota_media;
         $this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig][2] += $sum_resultado_medio;
         $this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig][3] += $sum_total_nota;
         $this->array_total_pista[$quebra_participante_orig][$quebra_pista_orig][4] += $sum_total_resultado;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->nota_media = $rs_res->fields[3] ;  
            $this->nota_media = (string)$this->nota_media;
            $this->resultado_medio = $rs_res->fields[4] ;  
            $this->resultado_medio = (string)$this->resultado_medio;
            $this->total_nota = $rs_res->fields[5] ;  
            $this->total_nota = (string)$this->total_nota;
            $this->total_resultado = $rs_res->fields[6] ;  
            $this->total_resultado = (string)$this->total_resultado;
            $this->participante_orig = $this->participante;
            $this->pista_orig = $this->pista;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->nota_media, $this->resultado_medio, $this->total_nota, $this->total_resultado, $this->participante, $this->pista, $this->participante_orig,  $this->pista_orig);
            }
   }
//
