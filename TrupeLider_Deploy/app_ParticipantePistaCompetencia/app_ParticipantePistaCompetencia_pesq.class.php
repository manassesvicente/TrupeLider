...
class app_ParticipantePistaCompetencia_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function app_ParticipantePistaCompetencia_pesq()
   {
   }
   ...
   {
      global 
      $participante_cond, $participante,
             $pista_cond, $pista,
      ...
      $this->init();
      if (isset($this->NM_ajax_info['param']['participante_cond']))
      {
          $participante_cond = $this->NM_ajax_info['param']['participante_cond'];
      }
      if (isset($this->NM_ajax_info['param']['participante']))
      {
          $participante = $this->NM_ajax_info['param']['participante'];
      }
      if (isset($this->NM_ajax_info['param']['pista_cond']))
      {
          $pista_cond = $this->NM_ajax_info['param']['pista_cond'];
      }
      if (isset($this->NM_ajax_info['param']['pista']))
      {
          $pista = $this->NM_ajax_info['param']['pista'];
      }
...
//-- ajax metodos ---
      ...
      else
      {
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // Exatamente igual
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // In&iacute;cio igual
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " iniciando por " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // Qualquer parte
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " que contenha " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= " " . $nome_sum . " like '%" . $campo . "%'";
                   $this->comando_filtro .= " " . $nome . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " que contenha " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // Diferente
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " diferente de " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // Maior que
               $this->comando        .= " $nome > " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum > " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome > " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " maior que " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // Maior ou igual
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " maior ou igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // Menor que
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " menor que " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // Menor ou igual
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " menor ou igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // Entre dois valores
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " entre " . $this->cmp_formatado[$nome_campo] . " e " . $this->cmp_formatado[$nome_campo . "2"] . "##*@@";
                   }
               }
            break;
            ...
            case "NU":     // Conte&uacute;do nulo
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " Conte&uacute;do nulo " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // Conte&uacute;do n&atilde;o nulo
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " Conte&uacute;do n&atilde;o nulo " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "app_ParticipantePistaCompetencia.php";
?>
<HTML>
<HEAD>
 <TITLE>Filtro para app_ParticipantePistaCompetencia</TITLE>
...
<HEAD>
 <TITLE>Filtro para app_ParticipantePistaCompetencia</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
<SCRIPT language="javascript" src="app_ParticipantePistaCompetencia_digita.js" ?>">
</SCRIPT>
<SCRIPT language="javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>">
</SCRIPT>
<SCRIPT language="javascript" src="app_ParticipantePistaCompetencia_tab_erro.js">
</SCRIPT>
 <SCRIPT language="javascript">
var NM_index = 0;
...
function NM_hide_menu()
{
 ...
 function nm_save_form()
 {
  ...
  app_ParticipantePistaCompetencia_do_ajax_save_filter();
 }
 function nm_submit_filter(obj_sel)
 {
  ...
  app_ParticipantePistaCompetencia_do_ajax_change_filter();
 }
 function nm_submit_filter_del()
 {
  ...
  app_ParticipantePistaCompetencia_do_ajax_delete_filter();
 }
 </SCRIPT>
<?php
include_once("app_ParticipantePistaCompetencia_sajax_js.php");
?>
</HEAD>
<BODY>
 <FORM name="F1" action="app_ParticipantePistaCompetencia.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page; ?>"> 
...
<?php
   ...
   {
?>
   <FORM name="form_cancel"  method="POST" action="app_ParticipantePistaCompetencia.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page; ?>"> 
      ...
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
       <TR valign="middle">
        ...
        <TD align="right" class="css_cabecalho">
          Filtro para app_ParticipantePistaCompetencia
        </TD>
       </TR>
       <TR valign="middle">
        <TD align="left" class="css_cabecalho">
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          $participante = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['participante']; 
          $participante_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['participante_cond']; 
          $pista = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['pista']; 
          $pista_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['pista_cond']; 
          $competencia = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['competencia']; 
          $competencia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['competencia_cond']; 
          $nota_media = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['nota_media']; 
          $nota_media_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['nota_media_cond']; 
          $resultado_medio = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['resultado_medio']; 
          $resultado_medio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['resultado_medio_cond']; 
          $total_nota = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['total_nota']; 
          $total_nota_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['total_nota_cond']; 
          $total_resultado = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['total_resultado']; 
          $total_resultado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['total_resultado_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($participante_cond) || empty($participante_cond))
      {
         $participante_cond = "eq";
      }
      if (!isset($pista_cond) || empty($pista_cond))
      {
         $pista_cond = "eq";
      }
...
?>
  ...
  <TD width="100%" height="">
   ...
   <tr>
     ...
     <TD class="css_lab_impar">
        <?php echo (isset($this->New_label['participante'])) ? $this->New_label['participante'] : "Participante"; ?>
     </TD>
     <TD class="css_cmp_impar"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="participante_cond">
       <OPTION value="eq" <?php if ("eq" == $participante_cond) { echo "selected"; } ?>>Exatamente igual</OPTION>
       <OPTION value="ii" <?php if ("ii" == $participante_cond) { echo "selected"; } ?>>In&iacute;cio igual</OPTION>
       <OPTION value="qp" <?php if ("qp" == $participante_cond) { echo "selected"; } ?>>Qualquer parte</OPTION>
       <OPTION value="df" <?php if ("df" == $participante_cond) { echo "selected"; } ?>>Diferente</OPTION>
      </SELECT>
       </TD>
     <TD  class="css_cmp_impar">
 ...
 $nmgp_tab_label .= "participante?#?" . $SC_Label . "?@?";
?>
<INPUT  type="text" name="participante" value="<?php echo $participante ?>"   size="14" style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
     ...
     <TD class="css_lab_par">
        <?php echo (isset($this->New_label['pista'])) ? $this->New_label['pista'] : "Pista"; ?>
     </TD>
     <TD class="css_cmp_par"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="pista_cond">
       <OPTION value="eq" <?php if ("eq" == $pista_cond) { echo "selected"; } ?>>Exatamente igual</OPTION>
       <OPTION value="ii" <?php if ("ii" == $pista_cond) { echo "selected"; } ?>>In&iacute;cio igual</OPTION>
       <OPTION value="qp" <?php if ("qp" == $pista_cond) { echo "selected"; } ?>>Qualquer parte</OPTION>
       <OPTION value="df" <?php if ("df" == $pista_cond) { echo "selected"; } ?>>Diferente</OPTION>
      </SELECT>
       </TD>
     <TD  class="css_cmp_par">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "pista?#?" . $SC_Label . "?@?";
?>
<INPUT  type="text" name="pista" value="<?php echo $pista ?>"   size="35" style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
     ...
     <TD class="css_cmp_impar"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="competencia_cond">
...
?>
<INPUT  type="text" name="competencia" value="<?php echo $competencia ?>"   size="35" style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
     ...
     <TD class="css_cmp_par"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="nota_media_cond">
...
?>
<INPUT  type="text" name="nota_media" value="<?php echo $nota_media ?>"   size="8" style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
     ...
     <TD class="css_cmp_impar"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="resultado_medio_cond">
...
?>
<INPUT  type="text" name="resultado_medio" value="<?php echo $resultado_medio ?>"   size="8" style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
     ...
     <TD class="css_cmp_par"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="total_nota_cond">
...
?>
<INPUT  type="text" name="total_nota" value="<?php echo $total_nota ?>"   size="8" style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
     ...
     <TD class="css_cmp_impar"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="total_resultado_cond">
...
?>
<INPUT  type="text" name="total_resultado" value="<?php echo $total_resultado ?>"   size="8" style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_ParticipantePistaCompetencia']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app_ParticipantePistaCompetencia']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.participante.value = "";
   document.F1.pista.value = "";
...
<?php
   ...
   {
       $NM_fil_ant = array();
       $NM_patch   = "SISTEMA/app_ParticipantePistaCompetencia";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      { 
          $NM_str_filter  = "";
          $NM_temp  = (isset($participante)) ? $participante : ""; 
          $NM_str_filter .= "participante#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($participante_cond)) ? $participante_cond : ""; 
          $NM_str_filter .= "participante_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($pista)) ? $pista : ""; 
          $NM_str_filter .= "pista#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($pista_cond)) ? $pista_cond : ""; 
          $NM_str_filter .= "pista_cond#NMF#" . $NM_temp . "@NMF@"; 
          ...
          $NM_patch .= "app_ParticipantePistaCompetencia/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0777);
              chmod($NM_patch, 0777);
   ...
   function recupera_filtro()
   {
      ...
      $Look_man = array();
      $tp_html['participante_cond'] = 'select';
      $tp_html['pista_cond'] = 'select';
   ...
   {
      global $participante_cond, $participante,
             $pista_cond, $pista,
             $competencia_cond, $competencia,
             $nota_media_cond, $nota_media,
             $resultado_medio_cond, $resultado_medio,
      ...
      $participante_cond_salva = $participante_cond; 
      if (!isset($participante_input_2) || $participante_input_2 == "")
      {
          $participante_input_2 = $participante;
      }
      $pista_cond_salva = $pista_cond; 
      if (!isset($pista_input_2) || $pista_input_2 == "")
      {
          $pista_input_2 = $pista;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['participante'] = $participante; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['participante_cond'] = $participante_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['pista'] = $pista; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['pista_cond'] = $pista_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['competencia'] = $competencia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['competencia_cond'] = $competencia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['nota_media'] = $nota_media; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['nota_media_cond'] = $nota_media_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['resultado_medio'] = $resultado_medio; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['resultado_medio_cond'] = $resultado_medio_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['total_nota'] = $total_nota; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['total_nota_cond'] = $total_nota_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['total_resultado'] = $total_resultado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['total_resultado_cond'] = $total_resultado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $participante;
      $this->cmp_formatado['participante'] = $Conteudo;
      $Conteudo = $participante_input_2;
      $this->cmp_formatado['participante2'] = $Conteudo;
      $Conteudo = $pista;
      $this->cmp_formatado['pista'] = $Conteudo;
      $Conteudo = $pista_input_2;
      $this->cmp_formatado['pista2'] = $Conteudo;
      ...
      //----- $participante
      if (isset($participante) || $participante_cond == "nu" || $participante_cond == "nn")
      {
         $this->monta_condicao("PARTICIPANTE", $participante_cond, $participante, "", "participante");
      }

      //----- $pista
      if (isset($pista) || $pista_cond == "nu" || $pista_cond == "nn")
      {
         $this->monta_condicao("PISTA", $pista_cond, $pista, "", "pista");
      }
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['where_pesq_lookup'] = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['where_pesq'] = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['where_pesq_salvo'] = $this->comando . $this->comando_fim;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] = "pesq";
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['prim_vez'] = "N";
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['cond_pesq'] .= $this->NM_operador;
      }
