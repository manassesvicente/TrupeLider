...
class app_ParticipantePistaCompetencia_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $arquivo;
   //---- Construtor
   function app_ParticipantePistaCompetencia_xls()
   {
   }
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas do Participante por Competência e Pista :: Excel</TITLE>
