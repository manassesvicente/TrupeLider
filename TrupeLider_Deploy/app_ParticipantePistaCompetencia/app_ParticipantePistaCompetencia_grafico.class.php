...
class app_ParticipantePistaCompetencia_grafico
{
   var $Db;
   var $Ini;
   var $Erro;
   ...
   //---- Construtor
   function app_ParticipantePistaCompetencia_grafico()
   {
   ...
   function monta_grafico()
   {
      ...
      {
          $graf_tipo    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_tipo'];
          $graf_alt     = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_alt'];
          $graf_larg    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_larg'];
          $graf_marg    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_margem'];
          $graf_asp     = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_aspec'];
          $graf_preen   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_preencher'];
          $graf_ex_val  = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_exibe_val'];
          $graf_ex_marc = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_exibe_marcas'];
          $this->graf_cor_fundo   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_cor_fundo'];
          $this->graf_cor_margens = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_cor_margens'];
          $this->graf_cor_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_cor_label'];
          $this->graf_cor_valores = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_cor_valores'];
          $this->graf_tipo_marcas = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_tipo_marcas'];
          $this->graf_angulo      = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_angulo'];
   ...
   {
      global 
             $nivel_quebra, $campo, $participante, $pista;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['graf_opc_atual'] == 1)
      {
         $this->sc_graf_sint = true;
      }
      //---- Total
      require_once($this->Ini->path_aplicacao . "app_ParticipantePistaCompetencia_total.class.php"); 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['contr_label_graf']['participante']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['contr_label_graf']['participante']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['contr_label_graf']['participante'];
      }
      $this->label[1] = "Pista";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['contr_label_graf']['pista']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['contr_label_graf']['pista']))
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['contr_label_graf']['pista'];
      }
   }
   ...
   function monta_arrays()
   {
      ...
      $this->total->resumo("gra", $this->array_total_participante, $this->array_total_pista);
      ksort($this->array_total_participante);
      ksort($this->array_total_pista);
      $this->total->grafico($this->array_label_geral, $this->array_datay_geral, $this->array_total_participante, $this->array_total_pista);
      if ($this->nivel == 0)
      {
   ...
   function grafico_generico($tipo, $width, $height, $margem, $aspecto, $preenche, $exibe_val, $exibe_marc, $datay, $label, $tit_datay, $tit_label, $tit_graf, $tip_pizza = "ABS")
   {
      ...
      if (empty($datay) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_ParticipantePistaCompetencia']['opcao'] == "pdf")
      {
         return;
      }
