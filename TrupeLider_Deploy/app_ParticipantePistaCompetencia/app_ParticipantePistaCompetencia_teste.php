...
?> 
<br> 
<B><FONT SIZE="4">app_ParticipantePistaCompetencia</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="app_ParticipantePistaCompetencia.php" 
               target="_self"> 
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="app_ParticipantePistaCompetencia.php"> 
</form> 
