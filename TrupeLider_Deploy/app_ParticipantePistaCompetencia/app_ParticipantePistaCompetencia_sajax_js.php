  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_ParticipantePistaCompetencia" == sTestField)
        {
...
//      document.F1.elements[sFieldName].value = scAjaxSpecCharParser(sFieldValue);
  ...
  // ---------- save_filter
  function app_ParticipantePistaCompetencia_do_ajax_save_filter()
  {
    var var_participante_cond = scAjaxGetFieldSelect("participante_cond");
    var var_participante = scAjaxGetFieldText("participante");
    var var_pista_cond = scAjaxGetFieldSelect("pista_cond");
    var var_pista = scAjaxGetFieldText("pista");
    var var_competencia_cond = scAjaxGetFieldSelect("competencia_cond");
    var var_competencia = scAjaxGetFieldText("competencia");
    var var_nota_media_cond = scAjaxGetFieldSelect("nota_media_cond");
    var var_nota_media = scAjaxGetFieldText("nota_media");
    var var_resultado_medio_cond = scAjaxGetFieldSelect("resultado_medio_cond");
    var var_resultado_medio = scAjaxGetFieldText("resultado_medio");
    var var_total_nota_cond = scAjaxGetFieldSelect("total_nota_cond");
    var var_total_nota = scAjaxGetFieldText("total_nota");
    var var_total_resultado_cond = scAjaxGetFieldSelect("total_resultado_cond");
    var var_total_resultado = scAjaxGetFieldText("total_resultado");
    var var_nmgp_save_name = scAjaxGetFieldText("nmgp_save_name");
    ...
    x_app_ParticipantePistaCompetencia_ajax_save_filter( var_participante_cond, var_participante, var_pista_cond, var_pista, var_competencia_cond, var_competencia, var_nota_media_cond, var_nota_media, var_resultado_medio_cond, var_resultado_medio, var_total_nota_cond, var_total_nota, var_total_resultado_cond, var_total_resultado, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, app_ParticipantePistaCompetencia_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function app_ParticipantePistaCompetencia_do_ajax_save_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    document.F1.NM_filters.selectedIndex = -1;
    document.F1.NM_filters_del.selectedIndex = -1;
    document.F1.nmgp_save_name.value = "";
    document.all.Apaga_filters.style.display = '';
    document.getElementById('sel_recup_filters').style.display = '';
    document.all.Salvar_filters.style.display = 'none';
  } // do_ajax_save_filter_cb

  // ---------- change_filter
  function app_ParticipantePistaCompetencia_do_ajax_change_filter()
  {
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters");
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_app_ParticipantePistaCompetencia_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, app_ParticipantePistaCompetencia_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function app_ParticipantePistaCompetencia_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
  ...
  // ---------- delete_filter
  function app_ParticipantePistaCompetencia_do_ajax_delete_filter()
  {
    var var_NM_filters_del = scAjaxGetFieldSelect("NM_filters_del");
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_app_ParticipantePistaCompetencia_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, app_ParticipantePistaCompetencia_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function app_ParticipantePistaCompetencia_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    document.F1.NM_filters.selectedIndex = -1;
    document.F1.NM_filters_del.selectedIndex = -1;
    if (document.F1.NM_filters_del.length == 1)
    {
  ...
  ajax_field_list[0] = "participante";
  ajax_field_list[1] = "pista";
  ajax_field_list[2] = "competencia";
  ajax_field_list[3] = "nota_media";
  ajax_field_list[4] = "resultado_medio";
  ajax_field_list[5] = "total_nota";
  ajax_field_list[6] = "total_resultado";

  var ajax_error_list = {
    "participante": {"label": "Participante", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "pista": {"label": "Pista", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "competencia": {"label": "Competência", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "nota_media": {"label": "Nota - Média", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "resultado_medio": {"label": "Resultado - Média", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "total_nota": {"label": "Nota - Total", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "total_resultado": {"label": "Resultado - Total", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
