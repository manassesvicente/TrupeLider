...
class app_LiderPistaCompHab_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- Construtor
   function app_LiderPistaCompHab_rtf()
   {
   ...
   {
         $this->texto_tag .= "<td>" . $this->habilidade . "</td>\r\n";
   }
   //----- nota_media
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas do Líder por Competência, Habilidade e Pista :: RTF</TITLE>
