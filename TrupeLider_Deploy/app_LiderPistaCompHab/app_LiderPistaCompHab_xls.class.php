...
class app_LiderPistaCompHab_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $arquivo;
   //---- Construtor
   function app_LiderPistaCompHab_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= "_app_LiderPistaCompHab";
      $this->arquivo   .= ".xls";
   ...
   function grava_arquivo()
   {
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "habilidade" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->xls_dados->write_string($this->xls_row, $this->xls_col, $SC_Label);
              $this->xls_col++;
          }
      ...
      while (!$rs->EOF)
      {
         ...
         $this->habilidade = $rs->fields[3] ;  
         $this->nota_media = $rs->fields[4] ;  
         $this->nota_media = (string)$this->nota_media;
         $this->resultado_medio = $rs->fields[5] ;  
         $this->resultado_medio = (string)$this->resultado_medio;
         $this->total_nota = $rs->fields[6] ;  
         $this->total_nota = (string)$this->total_nota;
         $this->total_resultado = $rs->fields[7] ;  
   ...
   {
         $this->xls_dados->write_string($this->xls_row, $this->xls_col, $this->pista);
         $this->xls_col++;
   }
   //----- competencia
   function NM_export_competencia()
   {
         $this->xls_dados->write_string($this->xls_row, $this->xls_col, $this->competencia);
         $this->xls_col++;
   }
   //----- habilidade
   function NM_export_habilidade()
   {
         $this->xls_dados->write_string($this->xls_row, $this->xls_col, $this->habilidade);
         $this->xls_col++;
   }
   //----- nota_media
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas do Líder por Competência, Habilidade e Pista :: Excel</TITLE>
...
<FORM name="F0" method=post action="app_LiderPistaCompHab.php"> 
