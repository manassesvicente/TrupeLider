...
class app_LiderPistaCompHab_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function app_LiderPistaCompHab_pesq()
   {
   }
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "LIDER_PISTA_COMP_HAB.$nome";
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // Exatamente igual
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // In&iacute;cio igual
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " iniciando por " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // Qualquer parte
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " que contenha " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= " " . $nome_sum . " like '%" . $campo . "%'";
                   $this->comando_filtro .= " " . $nome . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " que contenha " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // Diferente
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " diferente de " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // Maior que
               $this->comando        .= " $nome > " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum > " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome > " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " maior que " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // Maior ou igual
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " maior ou igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // Menor que
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " menor que " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // Menor ou igual
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " menor ou igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // Entre dois valores
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " entre " . $this->cmp_formatado[$nome_campo] . " e " . $this->cmp_formatado[$nome_campo . "2"] . "##*@@";
                   }
               }
            break;
            ...
            case "NU":     // Conte&uacute;do nulo
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " Conte&uacute;do nulo " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // Conte&uacute;do n&atilde;o nulo
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " Conte&uacute;do n&atilde;o nulo " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "app_LiderPistaCompHab.php";
?>
<HTML>
<HEAD>
 <TITLE>Filtro para app_LiderPistaCompHab</TITLE>
...
<HEAD>
 <TITLE>Filtro para app_LiderPistaCompHab</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
<SCRIPT language="javascript" src="app_LiderPistaCompHab_digita.js" ?>">
</SCRIPT>
<SCRIPT language="javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>">
</SCRIPT>
<SCRIPT language="javascript" src="app_LiderPistaCompHab_tab_erro.js">
</SCRIPT>
 <SCRIPT language="javascript">
var NM_index = 0;
...
function NM_hide_menu()
{
 ...
 function nm_save_form()
 {
  ...
  app_LiderPistaCompHab_do_ajax_save_filter();
 }
 function nm_submit_filter(obj_sel)
 {
  ...
  app_LiderPistaCompHab_do_ajax_change_filter();
 }
 function nm_submit_filter_del()
 {
  ...
  app_LiderPistaCompHab_do_ajax_delete_filter();
 }
 </SCRIPT>
<?php
include_once("app_LiderPistaCompHab_sajax_js.php");
?>
</HEAD>
<BODY>
 <FORM name="F1" action="app_LiderPistaCompHab.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page; ?>"> 
...
<?php
   ...
   {
?>
   <FORM name="form_cancel"  method="POST" action="app_LiderPistaCompHab.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page; ?>"> 
      ...
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
       <TR valign="middle">
        ...
        <TD align="right" class="css_cabecalho">
          Filtro para app_LiderPistaCompHab
        </TD>
       </TR>
       <TR valign="middle">
        <TD align="left" class="css_cabecalho">
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          $lider = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['lider']; 
          $lider_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['lider_cond']; 
          $pista = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['pista']; 
          $pista_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['pista_cond']; 
          $competencia = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['competencia']; 
          $competencia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['competencia_cond']; 
          $habilidade = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['habilidade']; 
          $habilidade_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['habilidade_cond']; 
          $nota_media = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['nota_media']; 
          $nota_media_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['nota_media_cond']; 
          $resultado_medio = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['resultado_medio']; 
          $resultado_medio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['resultado_medio_cond']; 
          $total_nota = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['total_nota']; 
          $total_nota_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['total_nota_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['NM_operador']; 
      } 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_LiderPistaCompHab']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app_LiderPistaCompHab']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
       $NM_fil_ant = array();
       $NM_patch   = "SISTEMA/app_LiderPistaCompHab";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      { 
          ...
          $NM_patch .= "app_LiderPistaCompHab/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0777);
              chmod($NM_patch, 0777);
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['lider'] = $lider; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['lider_cond'] = $lider_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['pista'] = $pista; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['pista_cond'] = $pista_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['competencia'] = $competencia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['competencia_cond'] = $competencia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['habilidade'] = $habilidade; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['habilidade_cond'] = $habilidade_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['nota_media'] = $nota_media; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['nota_media_cond'] = $nota_media_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['resultado_medio'] = $resultado_medio; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['resultado_medio_cond'] = $resultado_medio_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['total_nota'] = $total_nota; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['total_nota_cond'] = $total_nota_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $lider;
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['where_pesq_lookup'] = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['where_pesq'] = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['where_pesq_salvo'] = $this->comando . $this->comando_fim;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['opcao'] = "pesq";
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['prim_vez'] = "N";
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['cond_pesq'] .= $this->NM_operador;
      }
