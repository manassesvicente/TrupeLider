...
class app_LiderPistaCompHab_grafico
{
   var $Db;
   var $Ini;
   var $Erro;
   ...
   //---- Construtor
   function app_LiderPistaCompHab_grafico()
   {
   ...
   function monta_grafico()
   {
      ...
      {
          $graf_tipo    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_tipo'];
          $graf_alt     = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_alt'];
          $graf_larg    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_larg'];
          $graf_marg    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_margem'];
          $graf_asp     = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_aspec'];
          $graf_preen   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_preencher'];
          $graf_ex_val  = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_exibe_val'];
          $graf_ex_marc = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_exibe_marcas'];
          $this->graf_cor_fundo   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_cor_fundo'];
          $this->graf_cor_margens = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_cor_margens'];
          $this->graf_cor_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_cor_label'];
          $this->graf_cor_valores = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_cor_valores'];
          $this->graf_tipo_marcas = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_tipo_marcas'];
          $this->graf_angulo      = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_angulo'];
   ...
   {
      global 
             $nivel_quebra, $campo, $lider, $pista, $competencia;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['graf_opc_atual'] == 1)
      {
         $this->sc_graf_sint = true;
      }
      //---- Total
      require_once($this->Ini->path_aplicacao . "app_LiderPistaCompHab_total.class.php"); 
      ...
      $this->label    = array();
      $this->label[0] = "Líder";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['contr_label_graf']['lider']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['contr_label_graf']['lider']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['contr_label_graf']['lider'];
      }
      $this->label[1] = "Pista";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['contr_label_graf']['pista']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['contr_label_graf']['pista']))
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['contr_label_graf']['pista'];
      }
      $this->label[2] = "Competência";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['contr_label_graf']['competencia']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['contr_label_graf']['competencia']))
      {
         $this->label[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['contr_label_graf']['competencia'];
      }
   }
   ...
   function monta_arrays()
   {
      ...
      $this->total->resumo("gra", $this->array_total_lider, $this->array_total_pista, $this->array_total_competencia);
      ksort($this->array_total_lider);
      ksort($this->array_total_pista);
      ksort($this->array_total_competencia);
      $this->total->grafico($this->array_label_geral, $this->array_datay_geral, $this->array_total_lider, $this->array_total_pista, $this->array_total_competencia);
      if ($this->nivel == 0)
      {
      ...
      if ($this->nivel == 1)
      {
         $this->array_label = $this->array_label_geral[$this->nivel][$this->lider];
         if ($this->sc_graf_sint)
         {
             $this->array_datay[0] = $this->array_datay_geral[$this->nivel][$this->campo][$this->lider];
         }
         else
         {
             $nn = $this->nivel + 1;
      ...
      if ($this->nivel == 2)
      {
         $this->array_label = $this->array_label_geral[$this->nivel][$this->lider][$this->pista];
         $this->sc_graf_sint = true;
         $this->array_datay[0] = $this->array_datay_geral[$this->nivel][$this->campo][$this->lider][$this->pista];
      }
   ...
   function grafico_generico($tipo, $width, $height, $margem, $aspecto, $preenche, $exibe_val, $exibe_marc, $datay, $label, $tit_datay, $tit_label, $tit_graf, $tip_pizza = "ABS")
   {
      ...
      if (empty($datay) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompHab']['opcao'] == "pdf")
      {
         return;
      }
