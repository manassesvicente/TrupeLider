...
class app_LiderPistaCompHab_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- Construtor
   function app_LiderPistaCompHab_xml()
   {
   ...
   function grava_arquivo()
   {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<app_LiderPistaCompHab";
   ...
   {
         $this->xml_registro .= " habilidade =\"" . $this->trata_dados($this->habilidade) . "\"";
   }
   //----- nota_media
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas do Líder por Competência, Habilidade e Pista :: XML</TITLE>
