...
class app_LiderPistaCompHab_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- Construtor
   function app_LiderPistaCompHab_csv()
   {
   ...
   {
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->lider);
   ...
   {
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->habilidade);
      $this->csv_registro .= $this->delim_col . $this->delim_dados . $conteudo . $this->delim_dados;
   }
   //----- nota_media
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas do Líder por Competência, Habilidade e Pista :: CSV</TITLE>
