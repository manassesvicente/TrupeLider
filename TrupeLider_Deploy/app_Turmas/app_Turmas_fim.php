...
//----- Limpa variável de segurança
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_Turmas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_Turmas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_Turmas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['app_Turmas']['opc_psq']) || $fecha_janela)
   {
