<?php
   @session_start() ;
/**
 * $Id: nm_gp_gera_cep.php,v 1.8 2008/05/26 12:45:07 sergio Exp $
 */
/*******************************************************************
 * Script Case
 *------------------------------------------------------------------
...
<TABLE BORDER="0" CELLPADDING="5" CELLSPACING="0" WIDTH="100%">
 <TR>
  <TD>
   <FONT FACE="Tahoma, Arial, sans-serif" SIZE="2">
   O CEP <?php echo CEP_formata($CEP); ?> não foi localizado na base de dados.
   <BR>
...
function CEP_form_origem()
{
    ...
    {
        list($form_valor, $form_campo) = explode(",", $partes[$i]);
...
?>
  if (opener.document.getElementById('id_read_on_<?php echo $form_campo?>') )
  {
      opener.document.getElementById('id_read_on_<?php echo $form_campo?>').innerHTML = "<?php echo $form_dado?>";
  }
  if (opener.document.getElementById('id_ajax_label_<?php echo $form_campo?>') )
  {
      opener.document.getElementById('id_ajax_label_<?php echo $form_campo?>').innerHTML = "<?php echo $form_dado?>";
  }
  tipo = opener.document.<?php echo $form_dados["form"]; ?>.<?php echo $form_campo?>.type;
  if ("text" == tipo || "hidden" == tipo || "textarea" == tipo)
  {
   opener.document.<?php echo $form_dados["form"]; ?>.<?php echo $form_campo?>.value = "<?php echo $form_dado; ?>";
  }
  else
  {
     if ("select" == tipo || "select-one" == tipo)
     {
        tam = opener.document.<?php echo $form_dados["form"]; ?>.<?php echo $form_campo?>.length;
        for (i = 0; i < tam; i++)
        {
          if ("<?php echo $form_dado; ?>" == opener.document.<?php echo $form_dados["form"]; ?>.<?php echo $form_campo?>.options[i].value)
          {
             opener.document.<?php echo $form_dados["form"]; ?>.<?php echo $form_campo?>.options[i].selected = true;
          }
        }
     }
     else
     {
       ...
       for (i = 0; i < tam; i++)
       {
         if ("<?php echo $form_dado; ?>" == opener.document.<?php echo $form_dados["form"]; ?>.<?php echo $form_campo?>[i].value)
         {
            opener.document.<?php echo $form_dados["form"]; ?>.<?php echo $form_campo?>[i].checked = true;
         }
       }
     }
  }
<?php
/*
  Obj_Form = opener.document.<?php echo $form_dados["form"]; ?>.<?php echo $form_campo?>;
