  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_Turmas" == sTestField)
        {
...
//      document.F1.elements[sFieldName].value = scAjaxSpecCharParser(sFieldValue);
  ...
  // ---------- Validate cod_turma
  function do_ajax_app_Turmas_validate_cod_turma()
  {
    var nomeCampo_cod_turma = "cod_turma";
    var var_cod_turma = scAjaxGetFieldText(nomeCampo_cod_turma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_cod_turma(var_cod_turma, var_script_case_init, do_ajax_app_Turmas_validate_cod_turma_cb);
  } // do_ajax_app_Turmas_validate_cod_turma

  function do_ajax_app_Turmas_validate_cod_turma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cod_turma";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_cod_turma_cb

  // ---------- Validate descricao
  function do_ajax_app_Turmas_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_descricao(var_descricao, var_script_case_init, do_ajax_app_Turmas_validate_descricao_cb);
  } // do_ajax_app_Turmas_validate_descricao

  function do_ajax_app_Turmas_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_descricao_cb

  // ---------- Validate cep
  function do_ajax_app_Turmas_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_cep(var_cep, var_script_case_init, do_ajax_app_Turmas_validate_cep_cb);
  } // do_ajax_app_Turmas_validate_cep

  function do_ajax_app_Turmas_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cep";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_cep_cb

  // ---------- Validate estado
  function do_ajax_app_Turmas_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldText(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_estado(var_estado, var_script_case_init, do_ajax_app_Turmas_validate_estado_cb);
  } // do_ajax_app_Turmas_validate_estado

  function do_ajax_app_Turmas_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "estado";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_estado_cb

  // ---------- Validate cidade
  function do_ajax_app_Turmas_validate_cidade()
  {
    var nomeCampo_cidade = "cidade";
    var var_cidade = scAjaxGetFieldText(nomeCampo_cidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_cidade(var_cidade, var_script_case_init, do_ajax_app_Turmas_validate_cidade_cb);
  } // do_ajax_app_Turmas_validate_cidade

  function do_ajax_app_Turmas_validate_cidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cidade";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_cidade_cb

  // ---------- Validate bairro
  function do_ajax_app_Turmas_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_bairro(var_bairro, var_script_case_init, do_ajax_app_Turmas_validate_bairro_cb);
  } // do_ajax_app_Turmas_validate_bairro

  function do_ajax_app_Turmas_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bairro";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_bairro_cb

  // ---------- Validate logradouro
  function do_ajax_app_Turmas_validate_logradouro()
  {
    var nomeCampo_logradouro = "logradouro";
    var var_logradouro = scAjaxGetFieldText(nomeCampo_logradouro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_logradouro(var_logradouro, var_script_case_init, do_ajax_app_Turmas_validate_logradouro_cb);
  } // do_ajax_app_Turmas_validate_logradouro

  function do_ajax_app_Turmas_validate_logradouro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_logradouro_cb

  // ---------- Validate numero
  function do_ajax_app_Turmas_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_numero(var_numero, var_script_case_init, do_ajax_app_Turmas_validate_numero_cb);
  } // do_ajax_app_Turmas_validate_numero

  function do_ajax_app_Turmas_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "numero";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_numero_cb

  // ---------- Validate complemento
  function do_ajax_app_Turmas_validate_complemento()
  {
    var nomeCampo_complemento = "complemento";
    var var_complemento = scAjaxGetFieldText(nomeCampo_complemento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_complemento(var_complemento, var_script_case_init, do_ajax_app_Turmas_validate_complemento_cb);
  } // do_ajax_app_Turmas_validate_complemento

  function do_ajax_app_Turmas_validate_complemento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_complemento_cb

  // ---------- Validate email
  function do_ajax_app_Turmas_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_email(var_email, var_script_case_init, do_ajax_app_Turmas_validate_email_cb);
  } // do_ajax_app_Turmas_validate_email

  function do_ajax_app_Turmas_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "email";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_email_cb

  // ---------- Validate telefax
  function do_ajax_app_Turmas_validate_telefax()
  {
    var nomeCampo_telefax = "telefax";
    var var_telefax = scAjaxGetFieldText(nomeCampo_telefax);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_telefax(var_telefax, var_script_case_init, do_ajax_app_Turmas_validate_telefax_cb);
  } // do_ajax_app_Turmas_validate_telefax

  function do_ajax_app_Turmas_validate_telefax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "telefax";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_telefax_cb

  // ---------- Validate tel
  function do_ajax_app_Turmas_validate_tel()
  {
    var nomeCampo_tel = "tel";
    var var_tel = scAjaxGetFieldText(nomeCampo_tel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_tel(var_tel, var_script_case_init, do_ajax_app_Turmas_validate_tel_cb);
  } // do_ajax_app_Turmas_validate_tel

  function do_ajax_app_Turmas_validate_tel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tel";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_tel_cb

  // ---------- Validate obs
  function do_ajax_app_Turmas_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Turmas_validate_obs(var_obs, var_script_case_init, do_ajax_app_Turmas_validate_obs_cb);
  } // do_ajax_app_Turmas_validate_obs

  function do_ajax_app_Turmas_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "obs";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Turmas_validate_obs_cb
  // ---------- Form
  function do_ajax_app_Turmas_submit_form()
  {
    scAjaxHideMessage();
    var var_cod_turma = scAjaxGetFieldText("cod_turma");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_app_Turmas_submit_form(var_cod_turma, var_descricao, var_cep, var_estado, var_cidade, var_bairro, var_logradouro, var_numero, var_complemento, var_email, var_telefax, var_tel, var_obs, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_app_Turmas_submit_form_cb);
  } // do_ajax_app_Turmas_submit_form

  function do_ajax_app_Turmas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cod_turma");
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app_Turmas_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_app_Turmas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tel");
    scAjaxHideErrorDisplay("obs");
    var var_id_turma = document.F2.id_turma.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_app_Turmas_navigate_form(var_id_turma, var_nm_form_submit, var_nmgp_opcao, var_script_case_init, do_ajax_app_Turmas_navigate_form_cb);
  } // do_ajax_app_Turmas_navigate_form

  function do_ajax_app_Turmas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    document.F2.id_turma.value = scAjaxGetKeyValue("id_turma");
    scAjaxShowDebug();
...
{
?>
    do_ajax_app_Turmas_restore_buttons();
<?php
}
?>
  } // do_ajax_app_Turmas_navigate_form_cb
  ...
  ajax_field_list[0] = "cod_turma";
  ajax_field_list[1] = "descricao";
  ajax_field_list[2] = "cep";
  ajax_field_list[3] = "estado";
  ajax_field_list[4] = "cidade";
  ajax_field_list[5] = "bairro";
  ajax_field_list[6] = "logradouro";
  ajax_field_list[7] = "numero";
  ajax_field_list[8] = "complemento";
  ajax_field_list[9] = "email";
  ajax_field_list[10] = "telefax";
  ajax_field_list[11] = "tel";
  ajax_field_list[12] = "obs";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "cod_turma": {"label": "Código da Turma", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "logradouro": {"label": "Endereço", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "obs": {"label": "Observações", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["cod_turma"][1] = "cod_turma";
  ...
  var ajax_field_id = {
    "cod_turma": new Array("hidden_field_label_cod_turma", "hidden_field_data_cod_turma"),
