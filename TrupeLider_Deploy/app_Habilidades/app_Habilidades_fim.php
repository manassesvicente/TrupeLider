...
//----- Limpa variável de segurança
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_Habilidades"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_Habilidades"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_Habilidades']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['app_Habilidades']['opc_psq']) || $fecha_janela)
   {
