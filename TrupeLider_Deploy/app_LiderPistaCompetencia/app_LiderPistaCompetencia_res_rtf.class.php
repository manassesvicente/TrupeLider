...
class app_LiderPistaCompetencia_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   //---- Construtor
   function app_LiderPistaCompetencia_rtf()
   {
   ...
   {
      require_once($this->Ini->path_aplicacao . "app_LiderPistaCompetencia_resumo.class.php"); 
      require_once($this->Ini->path_third     . "/rtf/nm_rtf_class.php"); 
      $this->arquivo    = "sc_rtf";
      $this->arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
      $this->arquivo   .= "_app_LiderPistaCompetencia";
      $this->arquivo   .= ".rtf";
      $this->Res        = new app_LiderPistaCompetencia_resumo("out");
   ...
   function gera_texto_tag()
   {
      ...
      $this->texto_tag .= "</tr>";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['arr_total']['lider'] as $campo_lider => $dados_lider)
      {
         $this->resumo_campos = $dados_lider;
         $this->gera_linha($dados_lider[5], 0);
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['arr_total']['pista'][$campo_lider] as $campo_pista => $dados_pista)
         {
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas do Líder por Competência por Pista :: RTF</TITLE>
