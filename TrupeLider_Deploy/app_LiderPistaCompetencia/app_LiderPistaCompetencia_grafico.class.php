...
class app_LiderPistaCompetencia_grafico
{
   var $Db;
   var $Ini;
   var $Erro;
   ...
   //---- Construtor
   function app_LiderPistaCompetencia_grafico()
   {
   ...
   function monta_grafico()
   {
      ...
      {
          $graf_tipo    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_tipo'];
          $graf_alt     = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_alt'];
          $graf_larg    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_larg'];
          $graf_marg    = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_margem'];
          $graf_asp     = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_aspec'];
          $graf_preen   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_preencher'];
          $graf_ex_val  = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_exibe_val'];
          $graf_ex_marc = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_exibe_marcas'];
          $this->graf_cor_fundo   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_cor_fundo'];
          $this->graf_cor_margens = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_cor_margens'];
          $this->graf_cor_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_cor_label'];
          $this->graf_cor_valores = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_cor_valores'];
          $this->graf_tipo_marcas = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_tipo_marcas'];
          $this->graf_angulo      = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_angulo'];
   ...
   {
      global 
             $nivel_quebra, $campo, $lider, $pista;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['graf_opc_atual'] == 1)
      {
         $this->sc_graf_sint = true;
      }
      //---- Total
      require_once($this->Ini->path_aplicacao . "app_LiderPistaCompetencia_total.class.php"); 
      ...
      $this->label    = array();
      $this->label[0] = "Líder";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['contr_label_graf']['lider']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['contr_label_graf']['lider']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['contr_label_graf']['lider'];
      }
      $this->label[1] = "Pista";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['contr_label_graf']['pista']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['contr_label_graf']['pista']))
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['contr_label_graf']['pista'];
      }
   }
   ...
   function monta_arrays()
   {
      ...
      $this->total->resumo("gra", $this->array_total_lider, $this->array_total_pista);
      ksort($this->array_total_lider);
      ksort($this->array_total_pista);
      $this->total->grafico($this->array_label_geral, $this->array_datay_geral, $this->array_total_lider, $this->array_total_pista);
      if ($this->nivel == 0)
      {
   ...
   function grafico_generico($tipo, $width, $height, $margem, $aspecto, $preenche, $exibe_val, $exibe_marc, $datay, $label, $tit_datay, $tit_label, $tit_graf, $tip_pizza = "ABS")
   {
      ...
      if (empty($datay) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] == "pdf")
      {
         return;
      }
