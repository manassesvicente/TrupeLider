...
class app_LiderPistaCompetencia_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- Construtor
   function app_LiderPistaCompetencia_resumo($tipo = "")
   {
   ...
   { 
      ...
      $this->NM_raiz_img = ""; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] == "pdf" && !$this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['print_all'])
      { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['iframe_menu'] && !$this->NM_export)
      {
          $this->aba_iframe = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['array_graf_pdf'] = array();
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['contr_array_resumo'] == "OK")
      {
          $this->array_total_lider = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['arr_total']['lider'];
          $this->array_total_pista = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['arr_total']['pista'];
      }
      else
      {
          $this->totaliza();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['arr_total']['lider'] = $this->array_total_lider;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['arr_total']['pista'] = $this->array_total_pista;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      if ($this->NM_export)
      {
          return;
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] == "pdf" || $this->Print_All)
   {
   ...
   function inicializa_vars()
   {
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] = "print";
      ...
      $this->total   = new app_LiderPistaCompetencia_total($this->Ini->sc_page);
   ...
   function verifica_impressao()
   {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] == "print" && $nmgp_cor_print == "PB") || $nmgp_tipo_pdf == "pb")
      {
   ...
   function totaliza()
   {
      $this->total->resumo("res", $this->array_total_lider, $this->array_total_pista);
      ksort($this->array_total_lider);
      ksort($this->array_total_pista);
   }
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['print_all'])
       {
   ...
   function monta_titulo()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderPistaCompetencia.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=0&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['array_graf_pdf'][] = array("0" => 0, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderPistaCompetencia.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=1&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['array_graf_pdf'][] = array("0" => 1, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderPistaCompetencia.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=2&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['array_graf_pdf'][] = array("0" => 2, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderPistaCompetencia.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=3&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['array_graf_pdf'][] = array("0" => 3, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "print")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "pdf")
          {
      $nm_saida->saida("          <A href=\"app_LiderPistaCompetencia.php?script_case_init=" . $this->Ini->sc_page . "&nmgp_opcao=grafico&campo=4&nivel_quebra=0\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>\r\n");
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['array_graf_pdf'][] = array("0" => 4, "1" => 0);
      }
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
   }
   ...
   function monta_linha($campo, $nivel, $weight, $params, $geral="N")
   {
      ...
      $img_html = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "print" && 1 > $nivel && $params != "nao" && (1 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_LiderPistaCompetencia.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=0&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['array_graf_pdf'][] = array("0" => 0, "1" => $nivel + 1, "2" => $params);
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "print" && 1 > $nivel && $params != "nao" && (1 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_LiderPistaCompetencia.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=1&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['array_graf_pdf'][] = array("0" => 1, "1" => $nivel + 1, "2" => $params);
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "print" && 1 > $nivel && $params != "nao" && (1 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_LiderPistaCompetencia.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=2&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['array_graf_pdf'][] = array("0" => 2, "1" => $nivel + 1, "2" => $params);
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "print" && 1 > $nivel && $params != "nao" && (1 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_LiderPistaCompetencia.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=3&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['array_graf_pdf'][] = array("0" => 3, "1" => $nivel + 1, "2" => $params);
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "print" && 1 > $nivel && $params != "nao" && (1 == ($nivel + 1)))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['opcao'] != "pdf")
         {
            $img_html = "&nbsp;<A href=\"app_LiderPistaCompetencia.php?script_case_init=" .$this->Ini->sc_page . "&nmgp_opcao=grafico&campo=4&nivel_quebra=" . ($nivel + 1) . "$params\" target=\"_blank\"><IMG src=\"" . $this->Ini->path_botoes . "/nm_scriptcase3_green_bgraf.gif\" border=\"0\" align=\"middle\" title=\"Ver gr&aacute;fico\" /></A>";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['array_graf_pdf'][] = array("0" => 4, "1" => $nivel + 1, "2" => $params);
      }
   ...
   function monta_geral()
   {
      ...
      $this->resumo_campos = array();
      for ($i = 1; $i <= sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['tot_geral']); $i++)
      {
         $this->resumo_campos[] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_LiderPistaCompetencia']['tot_geral'][$i];
      }
   ...
   function adiciona_registro($sum_nota_media, $sum_resultado_medio, $sum_total_nota, $sum_total_resultado, $quebra_lider, $quebra_pista, $quebra_lider_orig, $quebra_pista_orig)
   {
      //----- Líder
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_order_by = " order by  LIDER asc, PISTA asc"; 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->nota_media, $this->resultado_medio, $this->total_nota, $this->total_resultado, $this->lider, $this->pista, $this->lider_orig,  $this->pista_orig);
            }
   }
//
