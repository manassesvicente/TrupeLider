...
//----- Limpa variável de segurança
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_ControleNotas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_ControleNotas"]);
   }
