<form name="F2" method=post 
               ...
               target="_self"> 
<input type=hidden name="id_etapa" value="<?php  echo $this->nmgp_dados_form['id_etapa'] ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['parms'] ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page ?>"/> 
</form> 
...
function NM_critica (form, campo, label, mask, tipo, intr, dec, min, max)
{
 ...
 NM_tab_crit[1] = new NM_critica('F1', 'cod_etapa', 'Código da Etapa', 'naomask', 'lista', 'cxab', 20, 'TUDO');
 NM_tab_crit[2] = new NM_critica('F1', 'descricao', 'Descrição da Etapa', 'naomask', 'lista', 'cxab', 120, 'TUDO');
 ...
 NM_tab_crit_1[1] = new NM_critica('F1', 'cod_etapa', 'Código da Etapa', 'naomask', 'lista', 'cxab', 20, 'TUDO');
 NM_tab_crit_1[2] = new NM_critica('F1', 'descricao', 'Descrição da Etapa', 'naomask', 'lista', 'cxab', 120, 'TUDO');
