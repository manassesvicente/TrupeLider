...
<html>
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo 'CADASTRO DAS ETAPAS'; } else { echo 'CADASTRO DAS ETAPAS'; } ?></TITLE>
 ...
 <SCRIPT language="javascript" src="app_Etapas_dynifs.js"></SCRIPT>
<?php
include_once("app_Etapas_sajax_js.php");
?>
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe']) ? 'marginwidth="0" marginheight="0" topmargin="0" leftmargin="0"' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['recarga'];
}
...
<script language="javascript" src="app_Etapas_digita.js"> 
</script> 
<?php
 include_once("app_Etapas_js0.php");
?>
<script language="javascript" src="app_Etapas_tab_erro.js"> 
</script> 
<script language="javascript"> 
 </script>
<form name="F1" method=post 
               action="app_Etapas.php" 
               target="_self"> 
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe']) ? 0 : "3";
?>
<table align="center" cellpadding=<?php echo $int_iframe_padding; ?> cellspacing=0 border=0 align=center >
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['mostra_cab'] != "N"))
  {
?>
<tr><td>
     ...
     <TD>
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
       ...
       <TR valign="middle">
        ...
        <TD align="center" class="css_cabecalho">
          <?php if ($this->nmgp_opcao == "novo") { echo "CADASTRO DAS ETAPAS"; } else { echo "CADASTRO DAS ETAPAS"; } ?>
        </TD>
        <TD style="font-size: 5px">
          &nbsp; &nbsp;
        </TD>
...
<tr><td align="center">
<?php
if ((!$this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && ($this->nm_flag_saida_novo == "S" && $this->nmgp_botoes['exit'] == "on") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe'] != "R") && (!$this->Embutida_call)) {
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") && (!$this->Embutida_call)) {
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Etapas']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") && (!$this->Embutida_call)) {
?>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" height="100%"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['cod_etapa']))
    {
        $this->nm_new_label['cod_etapa'] = 'Código da Etapa';
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $cod_etapa = $this->cod_etapa;
   $sStyleHidden_cod_etapa = '';
   if (isset($this->nmgp_cmp_hidden['cod_etapa']) && $this->nmgp_cmp_hidden['cod_etapa'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['cod_etapa']);
       $sStyleHidden_cod_etapa = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_cod_etapa = 'display: none;';
   $sStyleReadInp_cod_etapa = '';
   if (isset($this->nmgp_cmp_readonly['cod_etapa']) && $this->nmgp_cmp_readonly['cod_etapa'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['cod_etapa']);
       $sStyleReadLab_cod_etapa = '';
       $sStyleReadInp_cod_etapa = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['cod_etapa']) && $this->nmgp_cmp_hidden['cod_etapa'] == 'off') { $sc_hidden_yes++;  ?>
<input type=hidden name="cod_etapa" value="<?php echo str_replace('"', "&quot;", $cod_etapa) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd" id="hidden_field_label_cod_etapa" style="<?php echo $sStyleHidden_cod_etapa; ?>"><span id="id_label_cod_etapa"><?php echo $this->nm_new_label['cod_etapa']; ?></span>*</TD>
    <TD class="scFormDataOdd" id="hidden_field_data_cod_etapa" style="<?php echo $sStyleHidden_cod_etapa; ?>"><table style="border-width: 0px; border-collapse: collapse"><tr><td  class="scFormDataFontOdd" style="vertical-align: top; padding: 0px">
<?php if ($bTestReadOnly && isset($this->nmgp_cmp_readonly["cod_etapa"]) &&  $this->nmgp_cmp_readonly["cod_etapa"] == "on") { 

 ?>
<input type=hidden name="cod_etapa" value="<?php echo str_replace('"', "&quot;", $cod_etapa) . "\">" . $cod_etapa . ""; ?>
<?php } else { ?>
<span id="id_read_on_cod_etapa" style="<?php echo $sStyleReadLab_cod_etapa; ?>"><?php echo $this->cod_etapa; ?></span><span id="id_read_off_cod_etapa" style="<?php echo $sStyleReadInp_cod_etapa; ?>">
 <input class="scFormObjectOdd" type=text name="cod_etapa" value="<?php echo str_replace('"', "&quot;", $cod_etapa) ?>"
 onblur="scCssBlur(this); NM_onblur(); do_ajax_app_Etapas_validate_cod_etapa(); return false;" onfocus="scCssFocus(this); NM_onfocus(this.form.name, this.name, '<?php echo htmlentities("Código da Etapa")?>', 0, 'naomask', 'lista', 'cxab', 20, 'TUDO')" size=14 maxlength=20></span><?php } ?>
</td><td style="vertical-align: top; padding: 0px 0px 0px 5px"><table class="scErrorTable" style="display: none; position: absolute" id="id_error_display_cod_etapa_frame"><tr><td class="scErrorMessage"><span id="id_error_display_cod_etapa_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['descricao'] = 'Descrição da Etapa';
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<span id="id_read_on_descricao" style="<?php echo $sStyleReadLab_descricao; ?>"><?php echo $this->descricao; ?></span><span id="id_read_off_descricao" style="<?php echo $sStyleReadInp_descricao; ?>">
 ...
 onblur="scCssBlur(this); NM_onblur(); do_ajax_app_Etapas_validate_descricao(); return false;" onfocus="scCssFocus(this); NM_onfocus(this.form.name, this.name, '<?php echo htmlentities("Descrição da Etapa")?>', 0, 'naomask', 'lista', 'cxab', 120, 'TUDO')" size=35 maxlength=120></span><?php } ?>
...
<span id="id_read_on_obs" style="<?php echo $sStyleReadLab_obs; ?>"><?php echo $obs_val; ?></span><span id="id_read_off_obs" style="<?php echo $sStyleReadInp_obs; ?>">
 ...
 onblur="scCssBlur(this); NM_onblur(); do_ajax_app_Etapas_validate_obs(); return false;" onfocus="scCssFocus(this); NM_onfocus(this.form.name, this.name, '<?php echo htmlentities("Observações")?>', 0, 'naomask', 'lista', 'cxab', 250, 'TUDO')">
...
{
?>
<script>parent.scAjaxDetailStatus("app_Etapas");</script>
<?php
}
?>
<script>
