...
//----- Limpa variável de segurança
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_Etapas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_Etapas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_Etapas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['app_Etapas']['opc_psq']) || $fecha_janela)
   {
