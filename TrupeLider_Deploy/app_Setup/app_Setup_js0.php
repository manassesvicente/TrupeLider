<form name="F2" method=post 
               ...
               target="_self"> 
<input type=hidden name="id_setup" value="<?php  echo $this->nmgp_dados_form['id_setup'] ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_Setup']['parms'] ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page ?>"/> 
</form> 
...
{ 
    ...
    do_ajax_app_Setup_submit_form(y, z); 
} 
<?php
}
?>
