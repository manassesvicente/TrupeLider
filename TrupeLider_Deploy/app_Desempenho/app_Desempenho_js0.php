<form name="F2" method=post 
               ...
               target="_self"> 
<input type=hidden name="id_desemp" value="<?php  echo $this->nmgp_dados_form['id_desemp'] ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_Desempenho']['parms'] ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page ?>"/> 
</form> 
...
function NM_critica (form, campo, label, mask, tipo, intr, dec, min, max)
{
 ...
 NM_tab_crit = new NM_critica(11);
 NM_tab_crit[1] = new NM_critica('F1', 'cod_desemp', 'Código', 'naomask', 'lista', 'cxab', 30, 'TUDO');
 NM_tab_crit[2] = new NM_critica('F1', 'id_grupo', 'Grupo', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit[3] = new NM_critica('F1', 'id_etapa', 'Pista', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit[4] = new NM_critica('F1', 'id_votante', 'Votante', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit[5] = new NM_critica('F1', 'id_votado', 'Votado', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit[6] = new NM_critica('F1', 'id_competencia', 'Competência', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit[7] = new NM_critica('F1', 'peso', 'PESO', 'naomask', 'lista', 'cxab', 3, 'TUDO');
 NM_tab_crit[8] = new NM_critica('F1', 'id_habilidade', 'Habilidade', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit[9] = new NM_critica('F1', 'resultado', 'RESULTADO', 'naomask', 'lista', 'cxab', 2, 'TUDO');
 NM_tab_crit[10] = new NM_critica('F1', 'nota', 'NOTA', 'naomask', 'numeroedt', 2, -0, 99);
 NM_tab_crit[11] = new NM_critica('NM_final');
 NM_tab_crit_1 = new NM_critica(11);
 NM_tab_crit_1[1] = new NM_critica('F1', 'cod_desemp', 'Código', 'naomask', 'lista', 'cxab', 30, 'TUDO');
 NM_tab_crit_1[2] = new NM_critica('F1', 'id_grupo', 'Grupo', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit_1[3] = new NM_critica('F1', 'id_etapa', 'Pista', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit_1[4] = new NM_critica('F1', 'id_votante', 'Votante', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit_1[5] = new NM_critica('F1', 'id_votado', 'Votado', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit_1[6] = new NM_critica('F1', 'id_competencia', 'Competência', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit_1[7] = new NM_critica('F1', 'peso', 'PESO', 'naomask', 'lista', 'cxab', 3, 'TUDO');
 NM_tab_crit_1[8] = new NM_critica('F1', 'id_habilidade', 'Habilidade', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit_1[9] = new NM_critica('F1', 'resultado', 'RESULTADO', 'naomask', 'lista', 'cxab', 2, 'TUDO');
 NM_tab_crit_1[10] = new NM_critica('F1', 'nota', 'NOTA', 'naomask', 'numeroedt', 2, -0, 99);
 NM_tab_crit_1[11] = new NM_critica('NM_final');
