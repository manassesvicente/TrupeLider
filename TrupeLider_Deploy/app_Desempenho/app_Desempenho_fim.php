...
//----- Limpa variável de segurança
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_Desempenho"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_Desempenho"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_Desempenho']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['app_Desempenho']['opc_psq']) || $fecha_janela)
   {
