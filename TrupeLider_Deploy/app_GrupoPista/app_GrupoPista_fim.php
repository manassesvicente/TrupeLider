...
//----- Limpa variável de segurança
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_GrupoPista"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SISTEMA_____app_GrupoPista"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['app_GrupoPista']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['app_GrupoPista']['opc_psq']) || $fecha_janela)
   {
