...
class app_GrupoPista_xml
{
   ...
   function grava_arquivo()
   {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<app_GrupoPista";
   ...
   {
         $this->xml_registro .= " grupo =\"" . $this->trata_dados($this->grupo) . "\"";
   }
   //----- nota_media
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas dos Grupos por Pista :: XML</TITLE>
