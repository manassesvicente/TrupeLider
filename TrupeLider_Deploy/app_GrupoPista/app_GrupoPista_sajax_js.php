  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_GrupoPista" == sTestField)
        {
...
//      document.F1.elements[sFieldName].value = scAjaxSpecCharParser(sFieldValue);
  ...
  // ---------- save_filter
  function app_GrupoPista_do_ajax_save_filter()
  {
    ...
    x_app_GrupoPista_ajax_save_filter( var_pista_cond, var_pista, var_grupo_cond, var_grupo, var_nota_media_cond, var_nota_media, var_resultado_medio_cond, var_resultado_medio, var_total_nota_cond, var_total_nota, var_total_resultado_cond, var_total_resultado, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, app_GrupoPista_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function app_GrupoPista_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function app_GrupoPista_do_ajax_change_filter()
  {
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters");
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_app_GrupoPista_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, app_GrupoPista_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function app_GrupoPista_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
  ...
  // ---------- delete_filter
  function app_GrupoPista_do_ajax_delete_filter()
  {
    var var_NM_filters_del = scAjaxGetFieldSelect("NM_filters_del");
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_app_GrupoPista_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, app_GrupoPista_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function app_GrupoPista_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    document.F1.NM_filters.selectedIndex = -1;
  ...
  ajax_field_list[0] = "pista";
  ajax_field_list[1] = "grupo";
