...
class app_GrupoPista_xls
{
   ...
   function grava_arquivo()
   {
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         $this->xls_col = 0;
         $this->xls_row++;
         $this->pista = $rs->fields[0] ;  
         $this->grupo = $rs->fields[1] ;  
   ...
   {
         $this->xls_dados->write_string($this->xls_row, $this->xls_col, $this->grupo);
         $this->xls_col++;
   }
   //----- nota_media
...
<HTML>
<HEAD>
 <TITLE>Relatório das Notas dos Grupos por Pista :: Excel</TITLE>
