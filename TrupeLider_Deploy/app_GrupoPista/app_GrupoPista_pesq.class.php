...
class app_GrupoPista_pesq
{
   ...
   function processa_ajax()
   {
      ...
      if (isset($this->NM_ajax_info['param']['grupo_cond']))
      {
          $grupo_cond = $this->NM_ajax_info['param']['grupo_cond'];
      }
      if (isset($this->NM_ajax_info['param']['grupo']))
      {
          $grupo = $this->NM_ajax_info['param']['grupo'];
      }
...
//-- ajax metodos ---
      ...
      else
      {
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // Exatamente igual
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // In&iacute;cio igual
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " iniciando por " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // Qualquer parte
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " que contenha " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= " " . $nome_sum . " like '%" . $campo . "%'";
                   $this->comando_filtro .= " " . $nome . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " que contenha " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // Diferente
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " diferente de " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // Maior que
               $this->comando        .= " $nome > " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum > " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome > " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " maior que " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // Maior ou igual
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " maior ou igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // Menor que
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " menor que " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // Menor ou igual
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " menor ou igual a " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // Entre dois valores
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " entre " . $this->cmp_formatado[$nome_campo] . " e " . $this->cmp_formatado[$nome_campo . "2"] . "##*@@";
                   }
               }
            break;
            ...
            case "NU":     // Conte&uacute;do nulo
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " Conte&uacute;do nulo " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // Conte&uacute;do n&atilde;o nulo
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " Conte&uacute;do n&atilde;o nulo " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "app_GrupoPista.php";
?>
<HTML>
<HEAD>
 <TITLE>Filtro para app_GrupoPista</TITLE>
...
<HEAD>
 <TITLE>Filtro para app_GrupoPista</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
<SCRIPT language="javascript" src="app_GrupoPista_digita.js" ?>">
</SCRIPT>
<SCRIPT language="javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>">
</SCRIPT>
<SCRIPT language="javascript" src="app_GrupoPista_tab_erro.js">
</SCRIPT>
 <SCRIPT language="javascript">
var NM_index = 0;
...
function NM_hide_menu()
{
 ...
 function nm_save_form()
 {
  ...
  app_GrupoPista_do_ajax_save_filter();
 }
 function nm_submit_filter(obj_sel)
 {
  ...
  app_GrupoPista_do_ajax_change_filter();
 }
 function nm_submit_filter_del()
 {
  ...
  app_GrupoPista_do_ajax_delete_filter();
 }
 </SCRIPT>
<?php
include_once("app_GrupoPista_sajax_js.php");
?>
</HEAD>
<BODY>
 <FORM name="F1" action="app_GrupoPista.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page; ?>"> 
...
<?php
   ...
   {
?>
   <FORM name="form_cancel"  method="POST" action="app_GrupoPista.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page; ?>"> 
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          $pista = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['pista']; 
          $pista_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['pista_cond']; 
          $grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['grupo']; 
          $grupo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['grupo_cond']; 
          $nota_media = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['nota_media']; 
          $nota_media_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['nota_media_cond']; 
          $resultado_medio = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['resultado_medio']; 
          $resultado_medio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['resultado_medio_cond']; 
          $total_nota = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['total_nota']; 
          $total_nota_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['total_nota_cond']; 
          $total_resultado = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['total_resultado']; 
          $total_resultado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['total_resultado_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['NM_operador']; 
      } 
  ...
  <TD width="100%" height="">
   ...
   <tr>
     ...
     <TD class="css_cmp_impar"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="pista_cond">
...
?>
<INPUT  type="text" name="pista" value="<?php echo $pista ?>"   size="35" style="font-family:Verdana, Arial, sans-serif;font-size:11px;color:#333333;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
     ...
     <TD class="css_lab_par">
        <?php echo (isset($this->New_label['grupo'])) ? $this->New_label['grupo'] : "Grupo"; ?>
     </TD>
     <TD class="css_cmp_par"> 
      <SELECT style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;" name="grupo_cond">
       <OPTION value="eq" <?php if ("eq" == $grupo_cond) { echo "selected"; } ?>>Exatamente igual</OPTION>
       <OPTION value="ii" <?php if ("ii" == $grupo_cond) { echo "selected"; } ?>>In&iacute;cio igual</OPTION>
       <OPTION value="qp" <?php if ("qp" == $grupo_cond) { echo "selected"; } ?>>Qualquer parte</OPTION>
       <OPTION value="df" <?php if ("df" == $grupo_cond) { echo "selected"; } ?>>Diferente</OPTION>
      </SELECT>
       </TD>
     <TD  class="css_cmp_par">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" name="grupo" value="<?php echo $grupo ?>"   size="14" style="font-family:Verdana, Arial, sans-serif;font-size:11px;background-color:#F0FEED;border-width:1;border-color:#189300;border-style:solid;">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['app_GrupoPista']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['app_GrupoPista']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
       $NM_fil_ant = array();
       $NM_patch   = "SISTEMA/app_GrupoPista";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      { 
          ...
          $NM_temp  = (isset($grupo)) ? $grupo : ""; 
          $NM_str_filter .= "grupo#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($grupo_cond)) ? $grupo_cond : ""; 
          $NM_str_filter .= "grupo_cond#NMF#" . $NM_temp . "@NMF@"; 
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['pista'] = $pista; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['pista_cond'] = $pista_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['grupo'] = $grupo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['grupo_cond'] = $grupo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['nota_media'] = $nota_media; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['nota_media_cond'] = $nota_media_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['resultado_medio'] = $resultado_medio; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['resultado_medio_cond'] = $resultado_medio_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['total_nota'] = $total_nota; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['total_nota_cond'] = $total_nota_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['total_resultado'] = $total_resultado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['total_resultado_cond'] = $total_resultado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $pista;
      ...
      $Conteudo = $grupo_input_2;
      $this->cmp_formatado['grupo2'] = $Conteudo;
      $Conteudo = $nota_media;
      ...
      //----- $grupo
      if (isset($grupo) || $grupo_cond == "nu" || $grupo_cond == "nn")
      {
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['where_pesq_lookup'] = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['where_pesq'] = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['where_pesq_salvo'] = $this->comando . $this->comando_fim;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['opcao'] = "pesq";
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['prim_vez'] = "N";
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_GrupoPista']['cond_pesq'] .= $this->NM_operador;
      }
