  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_app_Grupos" == sTestField)
        {
...
//      document.F1.elements[sFieldName].value = scAjaxSpecCharParser(sFieldValue);
  ...
  // ---------- Validate id_turma
  function do_ajax_app_Grupos_validate_id_turma()
  {
  } // do_ajax_app_Grupos_validate_id_turma

  function do_ajax_app_Grupos_validate_id_turma_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Grupos_validate_id_turma_cb

  // ---------- Validate cod_grupo
  function do_ajax_app_Grupos_validate_cod_grupo()
  {
    var nomeCampo_cod_grupo = "cod_grupo";
    var var_cod_grupo = scAjaxGetFieldText(nomeCampo_cod_grupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Grupos_validate_cod_grupo(var_cod_grupo, var_script_case_init, do_ajax_app_Grupos_validate_cod_grupo_cb);
  } // do_ajax_app_Grupos_validate_cod_grupo

  function do_ajax_app_Grupos_validate_cod_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Grupos_validate_cod_grupo_cb

  // ---------- Validate descricao
  function do_ajax_app_Grupos_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Grupos_validate_descricao(var_descricao, var_script_case_init, do_ajax_app_Grupos_validate_descricao_cb);
  } // do_ajax_app_Grupos_validate_descricao

  function do_ajax_app_Grupos_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Grupos_validate_descricao_cb

  // ---------- Validate obs
  function do_ajax_app_Grupos_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Grupos_validate_obs(var_obs, var_script_case_init, do_ajax_app_Grupos_validate_obs_cb);
  } // do_ajax_app_Grupos_validate_obs

  function do_ajax_app_Grupos_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "obs";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Grupos_validate_obs_cb
  // ---------- Form
  function do_ajax_app_Grupos_submit_form()
  {
    scAjaxHideMessage();
    var var_id_turma = scAjaxGetFieldText("id_turma");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_app_Grupos_submit_form(var_id_turma, var_cod_grupo, var_descricao, var_obs, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_app_Grupos_submit_form_cb);
  } // do_ajax_app_Grupos_submit_form

  function do_ajax_app_Grupos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app_Grupos_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_app_Grupos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("descricao");
    scAjaxHideErrorDisplay("obs");
    var var_id_grupo = document.F2.id_grupo.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_app_Grupos_navigate_form(var_id_grupo, var_nm_form_submit, var_nmgp_opcao, var_script_case_init, do_ajax_app_Grupos_navigate_form_cb);
  } // do_ajax_app_Grupos_navigate_form

  function do_ajax_app_Grupos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    document.F2.id_grupo.value = scAjaxGetKeyValue("id_grupo");
    scAjaxShowDebug();
...
{
?>
    do_ajax_app_Grupos_restore_buttons();
<?php
}
?>
  } // do_ajax_app_Grupos_navigate_form_cb
  ...
  ajax_field_list[0] = "id_turma";
  ajax_field_list[1] = "cod_grupo";
  ajax_field_list[2] = "descricao";
  ajax_field_list[3] = "obs";
  ...
  var ajax_error_list = {
    ...
    "cod_grupo": {"label": "Código do Grupo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descricao": {"label": "Nome do Grupo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
