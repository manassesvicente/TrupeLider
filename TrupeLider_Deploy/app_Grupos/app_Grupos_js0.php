<form name="F2" method=post 
               ...
               target="_self"> 
<input type=hidden name="id_grupo" value="<?php  echo $this->nmgp_dados_form['id_grupo'] ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['app_Grupos']['parms'] ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->Ini->sc_page ?>"/> 
</form> 
...
function NM_critica (form, campo, label, mask, tipo, intr, dec, min, max)
{
 ...
 NM_tab_crit[1] = new NM_critica('F1', 'id_turma', 'Turma', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit[2] = new NM_critica('F1', 'cod_grupo', 'Código do Grupo', 'naomask', 'lista', 'cxab', 20, 'TUDO');
 NM_tab_crit[3] = new NM_critica('F1', 'descricao', 'Nome do Grupo', 'naomask', 'lista', 'cxab', 120, 'TUDO');
 NM_tab_crit[4] = new NM_critica('F1', 'obs', 'Observações', 'naomask', 'lista', 'cxab', 250, 'TUDO');
 NM_tab_crit[5] = new NM_critica('NM_final');
 NM_tab_crit_1 = new NM_critica(5);
 NM_tab_crit_1[1] = new NM_critica('F1', 'id_turma', 'Turma', 'naomask', 'lista', 'cxab', 10, 'TUDO');
 NM_tab_crit_1[2] = new NM_critica('F1', 'cod_grupo', 'Código do Grupo', 'naomask', 'lista', 'cxab', 20, 'TUDO');
 NM_tab_crit_1[3] = new NM_critica('F1', 'descricao', 'Nome do Grupo', 'naomask', 'lista', 'cxab', 120, 'TUDO');
 NM_tab_crit_1[4] = new NM_critica('F1', 'obs', 'Observações', 'naomask', 'lista', 'cxab', 250, 'TUDO');
